 ...
 */
export const makePointerEvent = (type: string, xy = {x: 0, y: 0}, node: Element) => {
  const props = {
    bubbles: true,
    cancelable: true,
    composed: true,
...
describe('BlockquoteBaseEmbeddedWebviewResize', () => {
  let el: import('../src/index').BlockquoteBaseEmbeddedWebviewResize;
  let elShadowRootHTML: string | null | undefined;
