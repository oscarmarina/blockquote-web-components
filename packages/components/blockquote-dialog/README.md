...
| Name                          | Privacy | Type                                 | Default                                                                                                                               | Description                                                                                                                                                                                                                                                                                                                                                                                            | Inherited From |
| ----------------------------- | ------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------- |
| `treewalker`                  |         | `IterableIterator<HTMLElement>`      | `walkComposedTree({ root: this, whatToShow: NodeFilter.SHOW_ELEMENT, filterAccept: isFocusable, filterReject: isElementInvisible, })` |                                                                                                                                                                                                                                                                                                                                                                                                        |                |
...
| `_firstFocusableChild`        |         | `HTMLElement \| null \| undefined`   | `undefined`                                                                                                                           |                                                                                                                                                                                                                                                                                                                                                                                                        |                |
| `_lastFocusableChild`         |         | `HTMLElement \| null \| undefined`   | `undefined`                                                                                                                           |                                                                                                                                                                                                                                                                                                                                                                                                        |                |
| `_nextClickIsFromContent`     |         | `boolean`                            | `false`                                                                                                                               |                                                                                                                                                                                                                                                                                                                                                                                                        |                |
| `_overflowRoot`               |         | `HTMLElement`                        |                                                                                                                                       |                                                                                                                                                                                                                                                                                                                                                                                                        |                |
| `_nativeDialogOpenObserver`   |         | `MutationController \| undefined`    | `undefined`                                                                                                                           |                                                                                                                                                                                                                                                                                                                                                                                                        |                |
| `_submitter`                  |         | `HTMLElement \| undefined`           |                                                                                                                                       |                                                                                                                                                                                                                                                                                                                                                                                                        |                |
| `scroller`                    |         | `HTMLElement \| null \| undefined`   |                                                                                                                                       |                                                                                                                                                                                                                                                                                                                                                                                                        |                |
| `returnValue`                 | public  | `string \| HTMLElement \| undefined` |                                                                                                                                       | Gets or sets the dialog's return value, usually to indicate which button&#xA;a user pressed to close it.&#xA;&#xA;https\://developer.mozilla.org/en-US/docs/Web/API/HTMLDialogElement/returnValue returnValue                                                                                                                                                                                          |                |
...
| ---- | ------------------ | ---------------- | ----------------------- | ------- |
| `js` | `BlockquoteDialog` | BlockquoteDialog | src/BlockquoteDialog.ts |         |
...
### `src/define/blockquote-dialog.ts`:
...
### `src/styles/blockqoute-dialog-animations-styles.css.ts`:
...
| Kind | Name     | Declaration | Module                                                | Package |
| ---- | -------- | ----------- | ----------------------------------------------------- | ------- |
| `js` | `styles` | styles      | src/styles/blockqoute-dialog-animations-styles.css.ts |         |

### `src/styles/blockquote-dialog-styles.css.ts`:
...
| Kind | Name     | Declaration | Module                                     | Package |
| ---- | -------- | ----------- | ------------------------------------------ | ------- |
| `js` | `styles` | styles      | src/styles/blockquote-dialog-styles.css.ts |         |
