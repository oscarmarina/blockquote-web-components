...
export class ProviderEl extends LitElement {
  private _provider!: BlockquoteControllerContextMeta<any, ProviderEl>;
...
export class ConsumerEl extends LitElement {
  ...
  _consumer = new BlockquoteControllerContextMeta<any, ConsumerEl>(this, {
    context: consumerContext,
    callback: (v: any) => v && (this.data = v),
  });
