...
*/const Ee=globalThis||window,xe=Symbol.for("BLOCKQUOTE"),ke=Symbol.for("blockquoteBaseMeta"),K=Symbol.for("types"),Z=Symbol.for("uuid"),te=Ee[xe]||Object.create(null),A=te[ke]||Object.create(null);A[K]=A[K]||new Map;A[Z]=A[Z]||Math.random().toString(36).substring(2,10);te[ke]=A;Ee[xe]=te;class R{constructor({type:e="default",key:t,value:i}={}){this.type=e,this.key=t,i!=null&&(this.value=i)}static get types(){return A[K]}static get uuid(){return A[Z]}get value(){const e=this.__key||this.key;this.__key=void 0;const t=R.types.get(this.type);return t==null?void 0:t.get(e)}set value(e){var t;if(this.type&&this.key){const i=(t=R.types.get(this.type))!=null?t:new Map;R.types.set(this.type,i),e!=null?i.set(this.key,e):i.delete(this.key)}}get list(){return Array.from(this.mapList.values())}get mapList(){var e;return(e=R.types.get(this.type))!=null?e:new Map}get objectList(){return Object.fromEntries(this.mapList)}byKey(e){return this.__key=e,this.value}}export{R as BlockquoteBaseMeta};
