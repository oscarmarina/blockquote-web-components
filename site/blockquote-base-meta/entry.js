var Se=Object.defineProperty;var Ce=(r,e,t)=>e in r?Se(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var S=(r,e,t)=>Ce(r,typeof e!="symbol"?e+"":e,t);/**
 * @license
...
*/const ke=globalThis||window,Ee=Symbol.for("BLOCKQUOTE"),xe=Symbol.for("blockquoteBaseMeta"),K=Symbol.for("types"),Z=Symbol.for("uuid"),te=ke[Ee]||Object.create(null),A=te[xe]||Object.create(null);A[K]=A[K]||new Map;A[Z]=A[Z]||Math.random().toString(36).substring(2,10);te[xe]=A;ke[Ee]=te;class R{constructor({type:e="default",key:t,value:i}={}){this.type=e,this.key=t,i!=null&&(this.value=i)}static get types(){return A[K]}static get uuid(){return A[Z]}get value(){const e=this.__key||this.key;this.__key=void 0;const t=R.types.get(this.type);return t==null?void 0:t.get(e)}set value(e){var t;if(this.type&&this.key){const i=(t=R.types.get(this.type))!=null?t:new Map;R.types.set(this.type,i),e!=null?i.set(this.key,e):i.delete(this.key)}}get list(){return Array.from(this.mapList.values())}get mapList(){var e;return(e=R.types.get(this.type))!=null?e:new Map}get objectList(){return Object.fromEntries(this.mapList)}byKey(e){return this.__key=e,this.value}}export{R as BlockquoteBaseMeta};
