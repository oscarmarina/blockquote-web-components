...
`,qe=class extends K{static get styles(){return[We]}static get properties(){return{heading:{type:String},selected:{type:Number},headingLevel:{type:Number,attribute:`heading-level`,reflect:!0,useDefault:!0},screenSizeSelected:{type:Number,attribute:`screen-size-selected`},limitHeight:{type:Boolean,attribute:`limit-height`,reflect:!0,useDefault:!0}}}constructor(){super(),this.__resetResizing=!1,this.__selectArrow=Ge,this.__readDataPos={x:`0`,y:`0`,resizing:!1,cursor:``},this._embeddedResizeRef=Fe(),this._updateSize=({detail:e})=>{var t,n;(t=this._embeddedResizeRef)==null||(t=t.value)==null||t.style.setProperty(`--blockquote-base-embedded-webview-resize-rect-width`,`${e.width}px`),(n=this._embeddedResizeRef)==null||(n=n.value)==null||n.style.setProperty(`--blockquote-base-embedded-webview-resize-rect-height`,this.limitHeight?`100%`:`${e.height}px`),this.__resetResizing=!1,this.requestUpdate()},this.selected=0,this.screenSizeSelected=0,this.headingLevel=1,this.heading=``,this.__resetResizing=!1,this.__selectArrow=Ge,this.__readDataPos={x:`0`,y:`0`,resizing:!1,cursor:``},this.limitHeight=!1,this._sources=[{src:``,option:``,description:``}],this._embeddedResizeRef=Fe()}async connectedCallback(){var e,t;(e=super.connectedCallback)==null||e.call(this),await this.updateComplete,this.addEventListener(`webviewresize`,e=>{let{detail:t}=e;if(Object.assign(this.__readDataPos,t),this.__resetResizing=!0,t.cursor===`n`||t.cursor===`ne`||t.cursor===`nw`){var n;window.scroll({top:Math.abs(parseInt(this.__readDataPos.y,10)+((n=this._controlBottom)==null?0:n)),left:0,behavior:`smooth`})}this.requestUpdate()});let n=Array.from(this.querySelectorAll(`template`));n.length&&(this._sources=n.map(e=>{let{src:t=``,option:n=``,description:r=``}=e.dataset;return{src:t,option:n,description:r}}),this._src=this._sources[this.selected].src),this.embedded=(t=this.shadowRoot)==null?void 0:t.querySelector(`[slot="embedded"]`),this._embeddedResizeRef.value&&(this._controlBottom=parseFloat(window.getComputedStyle(this._embeddedResizeRef.value).paddingBottom))}get _headingLevel(){return this.headingLevel>=1&&this.headingLevel<=6?this.headingLevel:2}render(){return N`
    ...
    `}_onChangeFile({target:e}){this.selected=e.selectedIndex,this._src=this._sources[this.selected].src}};window.customElements.define(`blockquote-base-embedded-webview`,qe);var Je=globalThis||window,Ye=Symbol.for(`BLOCKQUOTE`),Xe=Symbol.for(`blockquoteBaseMeta`),X=Symbol.for(`types`),Z=Symbol.for(`uuid`),Q=Je[Ye]||Object.create(null),$=Q[Xe]||Object.create(null);$[X]=$[X]||new Map,$[Z]=$[Z]||Math.random().toString(36).substring(2,10),Q[Xe]=$,Je[Ye]=Q;var Ze=class e{constructor({type:e=`default`,key:t,value:n}={}){this.type=e,this.key=t,n!=null&&(this.value=n)}static get types(){return $[X]}static get uuid(){return $[Z]}get value(){let t=this.__key||this.key;this.__key=void 0;let n=e.types.get(this.type);return n==null?void 0:n.get(t)}set value(t){if(this.type&&this.key){var n;let r=(n=e.types.get(this.type))==null?new Map:n;e.types.set(this.type,r),t==null?r.delete(this.key):r.set(this.key,t)}}get list(){return Array.from(this.mapList.values())}get mapList(){var t;return(t=e.types.get(this.type))==null?new Map:t}get objectList(){return Object.fromEntries(this.mapList)}byKey(e){return this.__key=e,this.value}};export{Ze as BlockquoteBaseMeta};