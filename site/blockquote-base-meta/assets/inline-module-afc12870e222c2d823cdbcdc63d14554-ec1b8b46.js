...
*/let Ct=0,Xe=0,S=[],Rt=0,de=!1,Ge=document.createTextNode("");new window.MutationObserver(function(){de=!1;const i=S.length;for(let e=0;e<i;e++){let t=S[e];if(t)try{t()}catch(s){setTimeout(()=>{throw s})}}S.splice(0,i),Xe+=i}).observe(Ge,{characterData:!0});const Tt={run:i=>(de||(de=!0,Ge.textContent=Rt++),S.push(i),Ct++),cancel(i){const e=i-Xe;if(e>=0){if(!S[e])throw new Error("invalid async handle: "+i);S[e]=null}}};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
