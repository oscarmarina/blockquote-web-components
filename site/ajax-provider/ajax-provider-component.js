 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const De={attribute:!0,type:String,converter:Pe,reflect:!1,hasChanged:Oe},_e=(o=De,e,t)=>{const{kind:r,metadata:a}=t;let n=globalThis.litPropertyMetadata.get(a);if(n===void 0&&globalThis.litPropertyMetadata.set(a,n=new Map),r==="setter"&&((o=Object.create(o)).wrapped=!0),n.set(t.name,o),r==="accessor"){const{name:s}=t;return{set(i){const d=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,d,o)},init(i){return i!==void 0&&this.C(s,void 0,o,i),i}}}if(r==="setter"){const{name:s}=t;return function(i){const d=this[s];e.call(this,i),this.requestUpdate(s,d,o)}}throw Error("Unsupported decorator location: "+r)};function c(o){return(e,t)=>typeof t=="object"?_e(o,e,t):((r,a,n)=>{const s=a.hasOwnProperty(n);return a.constructor.createProperty(n,r),s?Object.getOwnPropertyDescriptor(a,n):void 0})(o,e,t)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*me(o,e){if(o!==void 0){let t=0;for(const r of o)yield e(r,t++)}}var se=function(o,e,t,r){var a=arguments.length,n=a<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,r);else for(var i=o.length-1;i>=0;i--)(s=o[i])&&(n=(a<3?s(n):a>3?s(e,t,n):s(e,t))||n);return a>3&&n&&Object.defineProperty(e,t,n),n},P;let V=(P=class extends m{constructor(){super(...arguments),this.dimmed=!1}render(){return this.name}},P.styles=f`
    :host {
  ...
  `,E);xe([c({attribute:!1})],ne.prototype,"data",void 0);ne=xe([b("ix-object-value")],ne);const J=f`
  :host {
...
`,I="$",fe="*",Ce=o=>Array.from({length:o},(e,t)=>[I].concat(Array.from({length:t},()=>"*")).join(".")),Se=(o,e,t,r=0,a)=>{const n=[...Ce(r)].concat(t).filter(i=>typeof i=="string"),s=new Map;if(n.forEach(i=>{const d=i.split("."),x=(u,w,h)=>{var ce;if(h===d.length){s.set(w,!0);return}const v=d[h],O=e.hasChildren(u);if(h===0)O&&(v===I||v===fe)&&x(u,I,h+1);else if(v===fe)for(const{data:ee,name:je}of(ce=e.children(u))!=null?ce:[])O&&x(ee,`${w}.${je}`,h+1);else if(u!=null){const ee=u[v];O&&x(ee,`${w}.${v}`,h+1)}};x(o,"",0)}),a!==void 0)for(const[i,d]of a)d&&s.set(i,!0);return s};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Le=Ee(class extends Ne{constructor(o){var e;if(super(o),o.type!==Te.ATTRIBUTE||o.name!=="class"||((e=o.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(o){return" "+Object.keys(o).filter((e=>o[e])).join(" ")+" "}update(o,[e]){var r,a;if(this.st===void 0){this.st=new Set,o.strings!==void 0&&(this.nt=new Set(o.strings.join(" ").split(/\s/).filter((n=>n!==""))));for(const n in e)e[n]&&!((r=this.nt)!=null&&r.has(n))&&this.st.add(n);return this.render(e)}const t=o.element.classList;for(const n of this.st)n in e||(t.remove(n),this.st.delete(n));for(const n in e){const s=!!e[n];s===this.st.has(n)||(a=this.nt)!=null&&a.has(n)||(s?(t.add(n),this.st.add(n)):(t.remove(n),this.st.delete(n)))}return Re}});var G=function(o,e,t,r){var a=arguments.length,n=a<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,r);else for(var i=o.length-1;i>=0;i--)(s=o[i])&&(n=(a<3?s(n):a>3?s(e,t,n):s(e,t))||n);return a>3&&n&&Object.defineProperty(e,t,n),n},B,oe,q,N;let L=(N=class extends m{constructor(){super();j(this,B);j(this,q);this.expanded=!1,this.showGutter=!1,M(this,q,t=>{if(!p(this,B,oe))return;const r=this.renderRoot.querySelector("slot#children");t.composedPath().includes(r)||this.dispatchEvent(new re)}),this.addEventListener("click",p(this,q))}render(){return l`
      <div
        id="gutter"
    ...
    `],N);G([c({type:Boolean,reflect:!0})],L.prototype,"expanded",void 0);G([c({attribute:!1})],L.prototype,"treeAdapter",void 0);G([c({type:Boolean})],L.prototype,"showGutter",void 0);G([c({attribute:!1})],L.prototype,"item",void 0);L=G([b("ix-tree-node")],L);const X=class X extends Event{constructor(){super(X.eventName,{cancelable:!0})}};X.eventName="toggle-expanded";let re=X;const be=Object.getOwnPropertyNames;function Me(o,e){const t=Object.getOwnPropertyDescriptor(o,e);if(t!=null&&t.get)try{return t.get()}catch{return t.get}return o[e]}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*he(o,e){if(o!==void 0){let t=-1;for(const r of o)t>-1&&(yield e),t++,yield r}}var W=function(o,e,t,r){var a=arguments.length,n=a<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,r);else for(var i=o.length-1;i>=0;i--)(s=o[i])&&(n=(a<3?s(n):a>3?s(e,t,n):s(e,t))||n);return a>3&&n&&Object.defineProperty(e,t,n),n},T;let U=(T=class extends m{constructor(){super(...arguments),this.maxProperties=5,this.maxArrayItems=10}render(){const e=this.data;if(typeof e!="object"||e===null||e instanceof Date||e instanceof RegExp)return l`<ix-object-value .data=${e}></ix-object-value>`;if(Array.isArray(e)){const t=e.slice(0,this.maxArrayItems).map(a=>l`<ix-object-value .data=${a}></ix-object-value>`),r=e.length;return r>this.maxArrayItems&&t.push(l`<span>…</span>`),l`
        <span>${r===0?"":`(${r}) `}</span
        ><span>[${he(t,", ")}]</span>
      `}else{const t=be(e),r=t.slice(0,this.maxProperties).map(n=>{const s=Me(e,n);return l`<span
            ><ix-object-name .name=${n||'""'}></ix-object-name
            >:&nbsp;<ix-object-value .data=${s}></ix-object-value
  ...
  `,T);W([c({attribute:!1})],U.prototype,"data",void 0);W([c({type:Number})],U.prototype,"maxProperties",void 0);W([c({type:Number})],U.prototype,"maxArrayItems",void 0);U=W([b("ix-object-preview")],U);var $=function(o,e,t,r){var a=arguments.length,n=a<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,r);else for(var i=o.length-1;i>=0;i--)(s=o[i])&&(n=(a<3?s(n):a>3?s(e,t,n):s(e,t))||n);return a>3&&n&&Object.defineProperty(e,t,n),n},R;class Ie{constructor(e){j(this,R);this.expandedPaths=new Map,M(this,R,e)}requestUpdate(){return p(this,R).requestUpdate()}hasChildren(e){return typeof e=="object"&&e!==null||typeof e=="function"?Array.isArray(e)?e.length>0:typeof e[Symbol.iterator]=="function"?!0:be(e).length>0:!1}children(e){if(!this.hasChildren(e))return;const t=[];if(e instanceof Map)t.push({name:"[[Entries]]",data:new H(e),synthetic:!0,expanded:!0});else{if(e instanceof H)return t.push(...Array.from(e.map.entries()).map(([a,n])=>({name:String(a),data:n}))),t;if(e instanceof Set)t.push({name:"[[Entries]]",data:new k(e),synthetic:!0,expanded:!0});else{if(e instanceof k)return t.push(...Array.from(e.set.values()).map((a,n)=>({name:String(n),data:a}))),t;!Array.isArray(e)&&typeof e[Symbol.iterator]=="function"&&t.push(...Array.from(e).map((a,n)=>({name:n.toString(),data:a})))}}const r=Object.getOwnPropertyDescriptors(e);return t.push(...Object.entries(r).map(([a,n])=>({name:a,data:e[a],isNonEnumerable:!n.enumerable}))),t}render({item:e,depth:t=0,isNonEnumerable:r,parentPath:a}){var u,w;const n=a===void 0?I:`${a}.${e.name}`,s=(w=(u=this.expandedPaths.get(n))!=null?u:e.expanded)!=null?w:!1,i=typeof e.name=="string"&&e.name!==""?l`<ix-object-name
            .name=${e.name}
            .dimmed=${r!=null?r:!1}
          ></ix-object-name>`:t===0?void 0:l`<ix-object-preview .data=${e.name}></ix-object-preview>`,d=e.data instanceof H||e.data instanceof k?void 0:t===0?l`<ix-object-preview .data=${e.data}></ix-object-preview>`:l`<ix-object-value .data=${e.data}></ix-object-value>`,x=i&&d?l`<span>: </span>`:void 0;return l`<ix-tree-node
      .item=${e}
      .treeAdapter=${this}
      .expanded=${s}
      .showGutter=${t>0}
  ...
  `,D);ie([c({attribute:!1})],Y.prototype,"name",void 0);ie([c({type:Boolean,reflect:!0})],Y.prototype,"expanded",void 0);Y=ie([b("ix-dom-close-tag")],Y);var Q=function(o,e,t,r){var a=arguments.length,n=a<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,r);else for(var i=o.length-1;i>=0;i--)(s=o[i])&&(n=(a<3?s(n):a>3?s(e,t,n):s(e,t))||n);return a>3&&n&&Object.defineProperty(e,t,n),n},_;let z=(_=class extends m{constructor(){super(...arguments),this.expanded=!1}render(){var e;return l`<span
  ...
  `,_);Q([c()],z.prototype,"name",void 0);Q([c({attribute:!1})],z.prototype,"attributeData",void 0);Q([c({type:Boolean,reflect:!0})],z.prototype,"expanded",void 0);z=Q([b("ix-dom-open-tag")],z);const ve=(o,e=80)=>{var t,r;return o.nodeType===Node.ELEMENT_NODE&&((t=o.childNodes)==null?void 0:t.length)===1&&o.childNodes[0].nodeType===Node.TEXT_NODE&&((r=o.childNodes[0].textContent)==null?void 0:r.length)<e};var le=function(o,e,t,r){var a=arguments.length,n=a<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,r);else for(var i=o.length-1;i>=0;i--)(s=o[i])&&(n=(a<3?s(n):a>3?s(e,t,n):s(e,t))||n);return a>3&&n&&Object.defineProperty(e,t,n),n},C;let K=(C=class extends m{constructor(){super(...arguments),this.expanded=!1}render(){const{data:e}=this;if(e===void 0)return l`<span>undefined</span>`;switch(e.nodeType){case Node.ELEMENT_NODE:{const t=this.expanded?te:ve(e)?e.childNodes[0].textContent:"…";return l`<span
    ...
    `],C);le([c({attribute:!1})],K.prototype,"data",void 0);le([c({type:Boolean,reflect:!0})],K.prototype,"expanded",void 0);K=le([b("ix-dom-node-preview")],K);var ge=function(o,e,t,r){var a=arguments.length,n=a<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,r);else for(var i=o.length-1;i>=0;i--)(s=o[i])&&(n=(a<3?s(n):a>3?s(e,t,n):s(e,t))||n);return a>3&&n&&Object.defineProperty(e,t,n),n},F;class Ue{constructor(e){j(this,F);this.expandedPaths=new Map,M(this,F,e)}hasChildren(e){var t,r;return((r=(t=e.childNodes)==null?void 0:t.length)!=null?r:0)>0&&!(e.nodeType===Node.ELEMENT_NODE&&ve(e))}children(e){if(this.hasChildren(e))return e.childNodes.map((t,r)=>({name:`${t.nodeName}[${r}]`,data:t}))}render({item:e,depth:t=0,parentPath:r}){var s,i;const a=r===void 0?I:`${r}.${e.name}`,n=(i=(s=this.expandedPaths.get(a))!=null?s:e.expanded)!=null?i:!1;return l`<ix-tree-node
      .item=${e}
      .treeAdapter=${this}
      .depth=${t}
      .expanded=${n}
      .shouldShowPlaceholder=${t>0}
      @toggle-expanded=${()=>{var x,u;const d=(u=(x=this.expandedPaths.get(a))!=null?x:e.expanded)!=null?u:!1;this.expandedPaths.set(a,!d),p(this,F).requestUpdate()}}
      ><ix-dom-node-preview
        slot="label"
        .data=${e.data}
        .expanded=${n}
    ...
    `],S);ge([c({attribute:!1})],ae.prototype,"data",void 0);ae=ge([b("ix-dom-inspector")],ae);class ye extends m{async connectedCallback(){var e,t;(e=super.connectedCallback)==null||e.call(this),await this.updateComplete,this.json=(t=this.shadowRoot)==null?void 0:t.getElementById("json")}render(){return l`
