...
`,I="$",fe="*",Ce=o=>Array.from({length:o},(e,t)=>[I].concat(Array.from({length:t},()=>"*")).join(".")),Se=(o,e,t,r=0,a)=>{const n=[...Ce(r)].concat(t).filter(i=>typeof i=="string"),s=new Map;if(n.forEach(i=>{const d=i.split("."),x=(u,w,h)=>{var ce;if(h===d.length){s.set(w,!0);return}const v=d[h],O=e.hasChildren(u);if(h===0)O&&(v===I||v===fe)&&x(u,I,h+1);else if(v===fe)for(const{data:ee,name:je}of(ce=e.children(u))!=null?ce:[])O&&x(ee,`${w}.${je}`,h+1);else if(u!=null){const ee=u[v];O&&x(ee,`${w}.${v}`,h+1)}};x(o,"",0)}),a!==void 0)for(const[i,d]of a)d&&s.set(i,!0);return s};const Le=Ee(class extends Ne{constructor(o){var e;if(super(o),o.type!==Te.ATTRIBUTE||o.name!=="class"||((e=o.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(o){return" "+Object.keys(o).filter((e=>o[e])).join(" ")+" "}update(o,[e]){var r,a;if(this.st===void 0){this.st=new Set,o.strings!==void 0&&(this.nt=new Set(o.strings.join(" ").split(/\s/).filter((n=>n!==""))));for(const n in e)e[n]&&!((r=this.nt)!=null&&r.has(n))&&this.st.add(n);return this.render(e)}const t=o.element.classList;for(const n of this.st)n in e||(t.remove(n),this.st.delete(n));for(const n in e){const s=!!e[n];s===this.st.has(n)||(a=this.nt)!=null&&a.has(n)||(s?(t.add(n),this.st.add(n)):(t.remove(n),this.st.delete(n)))}return Re}});var G=function(o,e,t,r){var a=arguments.length,n=a<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,r);else for(var i=o.length-1;i>=0;i--)(s=o[i])&&(n=(a<3?s(n):a>3?s(e,t,n):s(e,t))||n);return a>3&&n&&Object.defineProperty(e,t,n),n},B,oe,q,N;let L=(N=class extends m{constructor(){super();j(this,B);j(this,q);this.expanded=!1,this.showGutter=!1,M(this,q,t=>{if(!p(this,B,oe))return;const r=this.renderRoot.querySelector("slot#children");t.composedPath().includes(r)||this.dispatchEvent(new re)}),this.addEventListener("click",p(this,q))}render(){return l`
    ...
    `],N);G([c({type:Boolean,reflect:!0})],L.prototype,"expanded",void 0);G([c({attribute:!1})],L.prototype,"treeAdapter",void 0);G([c({type:Boolean})],L.prototype,"showGutter",void 0);G([c({attribute:!1})],L.prototype,"item",void 0);L=G([b("ix-tree-node")],L);const X=class X extends Event{constructor(){super(X.eventName,{cancelable:!0})}};X.eventName="toggle-expanded";let re=X;const be=Object.getOwnPropertyNames;function Me(o,e){const t=Object.getOwnPropertyDescriptor(o,e);if(t!=null&&t.get)try{return t.get()}catch{return t.get}return o[e]}function*he(o,e){if(o!==void 0){let t=-1;for(const r of o)t>-1&&(yield e),t++,yield r}}var W=function(o,e,t,r){var a=arguments.length,n=a<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,e,t,r);else for(var i=o.length-1;i>=0;i--)(s=o[i])&&(n=(a<3?s(n):a>3?s(e,t,n):s(e,t))||n);return a>3&&n&&Object.defineProperty(e,t,n),n},T;let U=(T=class extends m{constructor(){super(...arguments),this.maxProperties=5,this.maxArrayItems=10}render(){const e=this.data;if(typeof e!="object"||e===null||e instanceof Date||e instanceof RegExp)return l`<ix-object-value .data=${e}></ix-object-value>`;if(Array.isArray(e)){const t=e.slice(0,this.maxArrayItems).map(a=>l`<ix-object-value .data=${a}></ix-object-value>`),r=e.length;return r>this.maxArrayItems&&t.push(l`<span>…</span>`),l`
        <span>${r===0?"":`(${r}) `}</span
        ><span>[${he(t,", ")}]</span>
