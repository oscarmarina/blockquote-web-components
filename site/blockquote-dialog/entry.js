 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xe={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Se=r=>(...e)=>({_$litDirective$:r,values:e});class Re{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const P=(r,e)=>{var i;const t=r._$AN;if(t===void 0)return!1;for(const s of t)(i=s._$AO)==null||i.call(s,e,!1),P(s,e);return!0},M=r=>{let e,t;do{if((e=r._$AM)===void 0)break;t=e._$AN,t.delete(r),r=e}while((t==null?void 0:t.size)===0)},Te=r=>{for(let e;e=r._$AM;r=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(r))break;t.add(r),rt(e)}};function it(r){this._$AN!==void 0?(M(this),this._$AM=r,Te(this)):this._$AM=r}function st(r,e=!1,t=0){const i=this._$AH,s=this._$AN;if(s!==void 0&&s.size!==0)if(e)if(Array.isArray(i))for(let n=t;n<i.length;n++)P(i[n],!1),M(i[n]);else i!=null&&(P(i,!1),M(i));else P(this,r)}const rt=r=>{var e,t;r.type==xe.CHILD&&((e=r._$AP)!=null||(r._$AP=st),(t=r._$AQ)!=null||(r._$AQ=it))};class ot extends Re{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Te(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,s;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)==null||i.call(this):(s=this.disconnected)==null||s.call(this)),t&&(P(this,e),M(this))}setValue(e){if(tt(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pe=()=>new nt;class nt{}const j=new WeakMap,qe=Se(class extends ot{render(r){return p}update(r,[e]){var i;const t=e!==this.Y;return t&&this.Y!==void 0&&this.rt(void 0),(t||this.lt!==this.ct)&&(this.Y=e,this.ht=(i=r.options)==null?void 0:i.host,this.rt(this.ct=r.element)),p}rt(r){var e;if(this.isConnected||(r=void 0),typeof this.Y=="function"){const t=(e=this.ht)!=null?e:globalThis;let i=j.get(t);i===void 0&&(i=new WeakMap,j.set(t,i)),i.get(this.Y)!==void 0&&this.Y.call(this.ht,void 0),i.set(this.Y,r),r!==void 0&&this.Y.call(this.ht,r)}else this.Y.value=r}get lt(){var r,e,t;return typeof this.Y=="function"?(e=j.get((r=this.ht)!=null?r:globalThis))==null?void 0:e.get(this.Y):(t=this.Y)==null?void 0:t.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),at=x`:host {
...
button[data-selected] ~ button:hover {
  background-color: var(--_button-bgcolor-selected-hover);
    ...
    `}_setSelected(t){t.preventDefault(),t.stopPropagation(),this.selected=Number(t.target.dataset.index);const i=new CustomEvent("click",{detail:this.selectedDetail});this.dispatchEvent(i)}}window.customElements.define("blockquote-base-embedded-webview-size",lt);const dt=x`:host {
...
.content {
  ...
  min-height: inherit;
}`,zt=x`/* Closed state of the dialog */
dialog {
  opacity: 0;
...
@starting-style {
  dialog[open]::backdrop {
    ...
    `}_handleSubmit(t){const{target:i,submitter:s}=t,n=(i==null?void 0:i.method)==="dialog",o=(s==null?void 0:s.formMethod)==="dialog";!n&&!o||(this._submitter=s,this.open=!1)}_handleOpen(){return W(this,"open",{cancelable:!0})}_handleClose(t){var s;this.returnValue=(s=this._submitter)!=null?s:this.returnValue,W(this,t,{cancelable:!0})&&(this.open=!1)}_handleCancel(t){const{target:i}=t;i!==this.dialogRef.value||!W(this,t,{cancelable:!0})||(this.open=!1)}_handleDialogClick(){if(this._nextClickIsFromContent){this._nextClickIsFromContent=!1;return}const{value:t}=this.dialogRef;t==null||t.dispatchEvent(new Event("cancel"))}_handleContentClick(){this._nextClickIsFromContent=!0}_firstFocusTrap({relatedTarget:t}){var i;(i=t!=null?this._firstFocusableChild:this._lastFocusableChild)==null||i.focus()}_lastFocusTrap({relatedTarget:t}){var i;(i=t!=null?this._lastFocusableChild:this._firstFocusableChild)==null||i.focus()}}E=new WeakMap,m(Z,"styles",[yt,zt]),m(Z,"properties",{open:{type:Boolean,reflect:!0},returnValue:{attribute:!1},label:{type:String},labelledby:{type:String},labelledbyVisible:{type:String,attribute:"labelledby-visibile"},type:{type:String,reflect:!0}});window.customElements.define("blockquote-dialog",Z);
