import{i as k,t as x,e as R,T as z,a as m,s as w,x as n,j as f}from"./directive-Cy4-p_oD.js";/**
 * @license
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const T=()=>new A;class A{}const v=new WeakMap,B=R(class extends S{render(s){return z}update(s,[e]){var i;const t=e!==this.Y;return t&&this.Y!==void 0&&this.rt(void 0),(t||this.lt!==this.ct)&&(this.Y=e,this.ht=(i=s.options)==null?void 0:i.host,this.rt(this.ct=s.element)),z}rt(s){var e;if(typeof this.Y=="function"){const t=(e=this.ht)!=null?e:globalThis;let i=v.get(t);i===void 0&&(i=new WeakMap,v.set(t,i)),i.get(this.Y)!==void 0&&this.Y.call(this.ht,void 0),i.set(this.Y,s),s!==void 0&&this.Y.call(this.ht,s)}else this.Y.value=s}get lt(){var s,e,t;return typeof this.Y=="function"?(e=v.get((s=this.ht)!=null?s:globalThis))==null?void 0:e.get(this.Y):(t=this.Y)==null?void 0:t.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),L=m`:host {
