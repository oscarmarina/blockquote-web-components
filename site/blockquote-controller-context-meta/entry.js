import{c as e,d as t,f as n,i as r,m as i,n as a,o,r as s,s as c}from"./assets/src-ZFMlM1TH.js";import"./directive/elements.js";import"./my-app.js";var{I:l}=n,u=e=>e.strings===void 0,d=(e,t)=>{var n;let r=e._$AN;if(r===void 0)return!1;for(let e of r)(n=e._$AO)==null||n.call(e,t,!1),d(e,t);return!0},f=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while((n==null?void 0:n.size)===0)},p=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),g(t)}};function m(e){this._$AN===void 0?this._$AM=e:(f(this),this._$AM=e,p(this))}function h(e,t=!1,n=0){let r=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0){if(t){if(Array.isArray(r))for(let e=n;e<r.length;e++)d(r[e],!1),f(r[e]);else r!=null&&(d(r,!1),f(r))}else d(this,e)}}var g=e=>{e.type==r.CHILD&&(e._$AP!=null||(e._$AP=h),e._$AQ!=null||(e._$AQ=m))},_=class extends s{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,n){super._$AT(e,t,n),p(this),this.isConnected=e._$AU}_$AO(e,t=!0){var n,r;e!==this.isConnected&&(this.isConnected=e,e?(n=this.reconnected)==null||n.call(this):(r=this.disconnected)==null||r.call(this)),t&&(d(this,e),f(this))}setValue(e){if(u(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}},v=()=>new y,y=class{},b=new WeakMap,x=a(class extends _{render(e){return c}update(e,[t]){var n;let r=t!==this.G;return r&&this.rt(void 0),(r||this.lt!==this.ct)&&(this.G=t,this.ht=(n=e.options)==null?void 0:n.host,this.rt(this.ct=e.element)),c}rt(e){if(this.G!==void 0){if(this.isConnected||(e=void 0),typeof this.G==`function`){var t;let n=(t=this.ht)==null?globalThis:t,r=b.get(n);r===void 0&&(r=new WeakMap,b.set(n,r)),r.get(this.G)!==void 0&&this.G.call(this.ht,void 0),r.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}}get lt(){var e,t,n;return typeof this.G==`function`?(e=b.get((t=this.ht)==null?globalThis:t))==null?void 0:e.get(this.G):(n=this.G)==null?void 0:n.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),S=i`
  :host {
    ...
    `}get _toolbarTpl(){return t`
      ${this.screenSizes.map((e,n)=>t`
          <button
            ...
            style="${this.widthInPercent?`width: calc(100% / ${n+1});`:`width: ${e.width}px;`}">
            <span>${e.id}</span>
          </button>
        `)}
    `}get _visualTextTpl(){return t`
      <span aria-disabled="${this.disabledSelectedSizeText}" aria-hidden="true">
        ${this.selectedSize.id}
      </span>
    `}_setSelected(e){e.preventDefault(),e.stopPropagation(),this.selected=Number(e.target.dataset.index);let t=new CustomEvent(`click`,{detail:this.selectedDetail});this.dispatchEvent(t)}};window.customElements.define(`blockquote-base-embedded-webview-size`,C);var w=i`
  :host {
