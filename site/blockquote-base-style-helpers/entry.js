var $=Object.defineProperty;var R=(s,i,e)=>i in s?$(s,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[i]=e;var h=(s,i,e)=>R(s,typeof i!="symbol"?i+"":i,e);import{A as k,i as w,a as _,b as n,D as y,B as C}from"./theme/theme.js";import{g as ie}from"./theme/theme.js";import"./theme/theme-font-face.js";import"./theme/theme-base-common.js";const E=s=>s.strings===void 0;const S={CHILD:2},q=s=>(...i)=>({_$litDirective$:s,values:i});class T{constructor(i){}get _$AU(){return this._$AM._$AU}_$AT(i,e,t){this._$Ct=i,this._$AM=e,this._$Ci=t}_$AS(i,e){return this.update(i,e)}update(i,e){return this.render(...e)}}const b=(s,i)=>{var t;const e=s._$AN;if(e===void 0)return!1;for(const r of e)(t=r._$AO)==null||t.call(r,i,!1),b(r,i);return!0},v=s=>{let i,e;do{if((i=s._$AM)===void 0)break;e=i._$AN,e.delete(s),s=i}while((e==null?void 0:e.size)===0)},x=s=>{for(let i;i=s._$AM;s=i){let e=i._$AN;if(e===void 0)i._$AN=e=new Set;else if(e.has(s))break;e.add(s),L(i)}};function A(s){this._$AN!==void 0?(v(this),this._$AM=s,x(this)):this._$AM=s}function B(s,i=!1,e=0){const t=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(i)if(Array.isArray(t))for(let o=e;o<t.length;o++)b(t[o],!1),v(t[o]);else t!=null&&(b(t,!1),v(t));else b(this,s)}const L=s=>{var i,e;s.type==S.CHILD&&((i=s._$AP)!=null||(s._$AP=B),(e=s._$AQ)!=null||(s._$AQ=A))};class D extends T{constructor(){super(...arguments),this._$AN=void 0}_$AT(i,e,t){super._$AT(i,e,t),x(this),this.isConnected=i._$AU}_$AO(i,e=!0){var t,r;i!==this.isConnected&&(this.isConnected=i,i?(t=this.reconnected)==null||t.call(this):(r=this.disconnected)==null||r.call(this)),e&&(b(this,i),v(this))}setValue(i){if(E(this._$Ct))this._$Ct._$AI(i,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=i,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}const P=()=>new H;class H{}const z=new WeakMap,M=q(class extends D{render(s){return k}update(s,[i]){var t;const e=i!==this.G;return e&&this.G!==void 0&&this.rt(void 0),(e||this.lt!==this.ct)&&(this.G=i,this.ht=(t=s.options)==null?void 0:t.host,this.rt(this.ct=s.element)),k}rt(s){var i;if(this.isConnected||(s=void 0),typeof this.G=="function"){const e=(i=this.ht)!=null?i:globalThis;let t=z.get(e);t===void 0&&(t=new WeakMap,z.set(e,t)),t.get(this.G)!==void 0&&this.G.call(this.ht,void 0),t.set(this.G,s),s!==void 0&&this.G.call(this.ht,s)}else this.G.value=s}get lt(){var s,i,e;return typeof this.G=="function"?(i=z.get((s=this.ht)!=null?s:globalThis))==null?void 0:i.get(this.G):(e=this.G)==null?void 0:e.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),I=w`
  :host {
...
`;class O extends _{constructor(){super();h(this,"_onResize",e=>{e.preventDefault(),e.stopPropagation(),window.requestAnimationFrame(()=>{this.requestUpdate()})});this.showOverflowSize=!1,this.selected=0,this.disabledSelectedSizeText=!1,this.screenSizes=[{width:360,height:800,id:"360x800"},{width:390,height:864,id:"390x864"},{width:414,height:896,id:"414x896"},{width:768,height:1024,id:"768x1024"},{width:810,height:1080,id:"810x1080"},{width:1280,height:720,id:"1280x800"},{width:1366,height:768,id:"1366x768"},{width:1536,height:864,id:"1536x864"},{width:1920,height:1080,id:"1920x1080"}],this.widthInPercent=!1}static get styles(){return[I]}static get properties(){return{screenSizes:{type:Array,attribute:"screen-sizes"},selected:{type:Number},widthInPercent:{type:Boolean,attribute:"width-in-percent"},showOverflowSize:{type:Boolean,attribute:"show-overflow-size"},disabledSelectedSizeText:{type:Boolean,attribute:"disabled-selected-size-text"}}}get selectedSize(){return this.screenSizes[this.selected-1]}get selectedDetail(){return{...this.selectedSize,index:this.selected}}get computedStyleWidth(){return parseInt(window.getComputedStyle(this).width,10)}connectedCallback(){super.connectedCallback&&super.connectedCallback(),window.addEventListener("resize",this._onResize)}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),window.removeEventListener("resize",this._onResize)}willUpdate(e){super.willUpdate&&super.willUpdate(e),e.has("screenSizes")&&this.screenSizes.sort((t,r)=>r.width-t.width),e.has("selected")&&(this.selected>this.screenSizes.length||this.selected===0)&&(this.selected=this.screenSizes.length)}updated(e){if(super.updated&&super.updated(e),e.has("selected")){const t=new CustomEvent("selectedchange",{bubbles:!0,detail:this.selectedDetail});this.dispatchEvent(t)}}render(){return n`
    ...
    `}_setSelected(e){e.preventDefault(),e.stopPropagation(),this.selected=Number(e.target.dataset.index);const t=new CustomEvent("click",{detail:this.selectedDetail});this.dispatchEvent(t)}}window.customElements.define("blockquote-base-embedded-webview-size",O);const W=w`
  :host {
...
`;class Y extends _{constructor(){super();h(this,"_updateSize",({detail:e})=>{var t,r,o,d;(r=(t=this._embeddedResizeRef)==null?void 0:t.value)==null||r.style.setProperty("--blockquote-base-embedded-webview-resize-rect-width",`${e.width}px`),(d=(o=this._embeddedResizeRef)==null?void 0:o.value)==null||d.style.setProperty("--blockquote-base-embedded-webview-resize-rect-height",this.limitHeight?"100%":`${e.height}px`),this.__resetResizing=!1,this.requestUpdate()});this.selected=0,this.screenSizeSelected=0,this.headingLevel=1,this.heading="",this.__resetResizing=!1,this.__selectArrow=j,this.__readDataPos={x:"0",y:"0",resizing:!1,cursor:""},this.limitHeight=!1,this._sources=[{src:"",option:"",description:""}],this._embeddedResizeRef=P()}static get styles(){return[U]}static get properties(){return{heading:{type:String},selected:{type:Number},headingLevel:{type:Number,attribute:"heading-level",reflect:!0,useDefault:!0},screenSizeSelected:{type:Number,attribute:"screen-size-selected"},limitHeight:{type:Boolean,attribute:"limit-height",reflect:!0,useDefault:!0}}}async connectedCallback(){var t,r;(t=super.connectedCallback)==null||t.call(this),await this.updateComplete,this.addEventListener("webviewresize",o=>{var a;const{detail:d}=o;Object.assign(this.__readDataPos,d),this.__resetResizing=!0,(d.cursor==="n"||d.cursor==="ne"||d.cursor==="nw")&&window.scroll({top:Math.abs(parseInt(this.__readDataPos.y,10)+((a=this._controlBottom)!=null?a:0)),left:0,behavior:"smooth"}),this.requestUpdate()});const e=Array.from(this.querySelectorAll("template"));e.length&&(this._sources=e.map(o=>{const{src:d="",option:a="",description:l=""}=o.dataset;return{src:d,option:a,description:l}}),this._src=this._sources[this.selected].src),this.embedded=(r=this.shadowRoot)==null?void 0:r.querySelector('[slot="embedded"]'),this._embeddedResizeRef.value&&(this._controlBottom=parseFloat(window.getComputedStyle(this._embeddedResizeRef.value).paddingBottom))}get _headingLevel(){return this.headingLevel>=1&&this.headingLevel<=6?this.headingLevel:2}render(){return n`
    ...
    `}get _mainTpl(){return n`
      <div class="main">
        <blockquote-base-embedded-webview-resize ${M(this._embeddedResizeRef)}>
    ...
    `}_onChangeFile({target:e}){this.selected=e.selectedIndex,this._src=this._sources[this.selected].src}}window.customElements.define("blockquote-base-embedded-webview",Y);const K=(s,i)=>{if(!i.cssText)throw new Error("Value passed to 'setComponentSharedStyles' function must be a 'css' function result");const e=new C({type:"sharedStyles",key:s});e.value=e.value||[],e.value.push(i)};export{_ as LitElement,w as css,ie as getComponentSharedStyles,n as html,K as setComponentSharedStyles};
