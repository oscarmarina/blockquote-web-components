 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const q=(r,e)=>{var s;const t=r._$AN;if(t===void 0)return!1;for(const i of t)(s=i._$AO)==null||s.call(i,e,!1),q(i,e);return!0},I=r=>{let e,t;do{if((e=r._$AM)===void 0)break;t=e._$AN,t.delete(r),r=e}while((t==null?void 0:t.size)===0)},Ee=r=>{for(let e;e=r._$AM;r=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(r))break;t.add(r),it(e)}};function tt(r){this._$AN!==void 0?(I(this),this._$AM=r,Ee(this)):this._$AM=r}function st(r,e=!1,t=0){const s=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(e)if(Array.isArray(s))for(let n=t;n<s.length;n++)q(s[n],!1),I(s[n]);else s!=null&&(q(s,!1),I(s));else q(this,r)}const it=r=>{var e,t;r.type==Xe.CHILD&&((e=r._$AP)!=null||(r._$AP=st),(t=r._$AQ)!=null||(r._$AQ=tt))};class rt extends et{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,s){super._$AT(e,t,s),Ee(this),this.isConnected=e._$AU}_$AO(e,t=!0){var s,i;e!==this.isConnected&&(this.isConnected=e,e?(s=this.reconnected)==null||s.call(this):(i=this.disconnected)==null||i.call(this)),t&&(q(this,e),I(this))}setValue(e){if(Ye(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
*/const Ce=globalThis||window,Re=Symbol.for("BLOCKQUOTE"),Ue=Symbol.for("blockquoteBaseMeta"),Y=Symbol.for("types"),X=Symbol.for("uuid"),ie=Ce[Re]||Object.create(null),k=ie[Ue]||Object.create(null);k[Y]=k[Y]||new Map;k[X]=k[X]||Math.random().toString(36).substring(2,10);ie[Ue]=k;Ce[Re]=ie;class z{constructor({type:e="default",key:t,value:s}={}){this.type=e,this.key=t,s!=null&&(this.value=s)}static get types(){return k[Y]}static get uuid(){return k[X]}get value(){const e=this.__key||this.key;this.__key=void 0;const t=z.types.get(this.type);return t==null?void 0:t.get(e)}set value(e){var t;if(this.type&&this.key){const s=(t=z.types.get(this.type))!=null?t:new Map;z.types.set(this.type,s),e!=null?s.set(this.key,e):s.delete(this.key)}}get list(){return Array.from(this.mapList.values())}get mapList(){var e;return(e=z.types.get(this.type))!=null?e:new Map}get objectList(){return Object.fromEntries(this.mapList)}byKey(e){return this.__key=e,this.value}}const Tt=(r,e)=>{if(!e.cssText)throw new Error("Value passed to 'setComponentSharedStyles' function must be a 'css' function result");const t=new z({type:"sharedStyles",key:r});t.value=t.value||[],t.value.push(e)},yt=new z({type:"sharedStyles"}),Pt=r=>{const e=yt.byKey(r);return e?e.filter(s=>s.cssText):[]},zt={main:`
  ...
  `},At={"--red-300":"#e57373","--red-400":"#ef5350","--red-500":"#f44336","--red-600":"#e53935","--red-700":"#c04545"},St={"--green-300":"#aed581","--green-400":"#9ccc65","--green-500":"#8bc34a","--green-600":"#7cb342","--green-700":"#689f38"},kt={"--blue-300":"#0f3058","--blue-400":"#102a4c","--blue-500":"#10243e","--blue-600":"#0f1b2d","--blue-700":"#0f1720"},b={colors:{...At,...St,...kt},fontFace:{...zt},fonts:{main:"Kaisei HarunoUmi, serif"}},Et=`
${b.fontFace.main}
:root {
