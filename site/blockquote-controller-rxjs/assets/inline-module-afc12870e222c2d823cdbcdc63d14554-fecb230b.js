var ne=Object.defineProperty,de=Object.defineProperties;var ae=Object.getOwnPropertyDescriptors;var O=Object.getOwnPropertySymbols;var ce=Object.prototype.hasOwnProperty,le=Object.prototype.propertyIsEnumerable;var H=(t,e,i)=>e in t?ne(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,I=(t,e)=>{for(var i in e||(e={}))ce.call(e,i)&&H(t,i,e[i]);if(O)for(var i of O(e))le.call(e,i)&&H(t,i,e[i]);return t},U=(t,e)=>de(t,ae(e));import{A as Y,i as $,s as E,x as d,D as Q}from"./lit-element-0f7698d3.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const z=(t,e)=>{var i,s;const r=t._$AN;if(r===void 0)return!1;for(const o of r)(s=(i=o)._$AO)===null||s===void 0||s.call(i,e,!1),z(o,e);return!0},x=t=>{let e,i;do{if((e=t._$AM)===void 0)break;i=e._$AN,i.delete(t),t=e}while((i==null?void 0:i.size)===0)},J=t=>{for(let e;e=t._$AM;t=e){let i=e._$AN;if(i===void 0)e._$AN=i=new Set;else if(i.has(t))break;i.add(t),ve(e)}};function pe(t){this._$AN!==void 0?(x(this),this._$AM=t,J(this)):this._$AM=t}function ge(t,e=!1,i=0){const s=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(e)if(Array.isArray(s))for(let o=i;o<s.length;o++)z(s[o],!1),x(s[o]);else s!=null&&(z(s,!1),x(s));else z(this,t)}const ve=t=>{var e,i,s,r;t.type==ue.CHILD&&((e=(s=t)._$AP)!==null&&e!==void 0||(s._$AP=ge),(i=(r=t)._$AQ)!==null&&i!==void 0||(r._$AQ=pe))};let fe=class extends me{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,i,s){super._$AT(e,i,s),J(this),this.isConnected=e._$AU}_$AO(e,i=!0){var s,r;e!==this.isConnected&&(this.isConnected=e,e?(s=this.reconnected)===null||s===void 0||s.call(this):(r=this.disconnected)===null||r===void 0||r.call(this)),i&&(z(this,e),x(this))}setValue(e){if(he(this._$Ct))this._$Ct._$AI(e,this);else{const i=[...this._$Ct._$AH];i[this._$Ci]=e,this._$Ct._$AI(i,this,0)}}disconnected(){}reconnected(){}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const we=()=>new _e;let _e=class{};const C=new WeakMap,ze=be(class extends fe{render(t){return Y}update(t,[e]){var i;const s=e!==this.G;return s&&this.G!==void 0&&this.ot(void 0),(s||this.rt!==this.lt)&&(this.G=e,this.dt=(i=t.options)===null||i===void 0?void 0:i.host,this.ot(this.lt=t.element)),Y}ot(t){var e;if(typeof this.G=="function"){const i=(e=this.dt)!==null&&e!==void 0?e:globalThis;let s=C.get(i);s===void 0&&(s=new WeakMap,C.set(i,s)),s.get(this.G)!==void 0&&this.G.call(this.dt,void 0),s.set(this.G,t),t!==void 0&&this.G.call(this.dt,t)}else this.G.value=t}get rt(){var t,e,i;return typeof this.G=="function"?(e=C.get((t=this.dt)!==null&&t!==void 0?t:globalThis))===null||e===void 0?void 0:e.get(this.G):(i=this.G)===null||i===void 0?void 0:i.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}}),ye=$`:host {
...
*/let xe=0,K=0,w=[],ke=0,L=!1,ee=document.createTextNode("");new window.MutationObserver(function(){L=!1;const t=w.length;for(let e=0;e<t;e++){let i=w[e];if(i)try{i()}catch(s){setTimeout(()=>{throw s})}}w.splice(0,t),K+=t}).observe(ee,{characterData:!0});const $e={run:t=>(L||(L=!0,ee.textContent=ke++),w.push(t),xe++),cancel(t){const e=t-K;if(e>=0){if(!w[e])throw new Error("invalid async handle: "+t);w[e]=null}}};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Ee=window.ShadyDOM&&window.ShadyDOM.noPatch&&window.ShadyDOM.wrap?window.ShadyDOM.wrap:window.ShadyDOM?t=>ShadyDOM.patch(t):t=>t;/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let te=typeof document.head.style.touchAction=="string",D="__polymerGestures",S="__polymerGesturesHandled",M="__polymerGesturesTouchAction",Re=["mousedown","mousemove","mouseup","click"],Te=[0,1,4,2],Ce=function(){try{return new MouseEvent("test",{buttons:1}).buttons===1}catch(t){return!1}}();function ie(t){return Re.indexOf(t)>-1}let Se=!1;(function(){try{let t=Object.defineProperty({},"passive",{get(){Se=!0}});window.addEventListener("test",null,t),window.removeEventListener("test",null,t)}catch(t){}})();let qe=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/);const Ae={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};function g(t){let e=t.type;if(!ie(e))return!1;if(e==="mousemove"){let i=t.buttons===void 0?1:t.buttons;return t instanceof window.MouseEvent&&!Ce&&(i=Te[t.which]||0),!!(1&i)}return(t.button===void 0?0:t.button)===0}let m={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};function G(t,e,i){t.movefn=e,t.upfn=i,document.addEventListener("mousemove",e),document.addEventListener("mouseup",i)}function f(t){document.removeEventListener("mousemove",t.movefn),document.removeEventListener("mouseup",t.upfn),t.movefn=null,t.upfn=null}const se=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:t=>t.composedPath&&t.composedPath()||[],y={},v=[];function Le(t,e){let i=document.elementFromPoint(t,e),s=i;for(;s&&s.shadowRoot&&!window.ShadyDOM;){let r=s;if(s=s.shadowRoot.elementFromPoint(t,e),r===s)break;s&&(i=s)}return i}function p(t){const e=se(t);return e.length>0?e[0]:t.target}function re(t){let e,i=t.type,s=t.currentTarget.__polymerGestures;if(!s)return;let r=s[i];if(r){if(!t[S]&&(t[S]={},i.slice(0,5)==="touch")){let o=t.changedTouches[0];if(i==="touchstart"&&t.touches.length===1&&(m.touch.id=o.identifier),m.touch.id!==o.identifier)return;te||i!=="touchstart"&&i!=="touchmove"||function(n){let h=n.changedTouches[0],l=n.type;if(l==="touchstart")m.touch.x=h.clientX,m.touch.y=h.clientY,m.touch.scrollDecided=!1;else if(l==="touchmove"){if(m.touch.scrollDecided)return;m.touch.scrollDecided=!0;let u=function(oe){let P="auto",N=se(oe);for(let R,T=0;T<N.length;T++)if(R=N[T],R[M]){P=R[M];break}return P}(n),c=!1,a=Math.abs(m.touch.x-h.clientX),b=Math.abs(m.touch.y-h.clientY);n.cancelable&&(u==="none"?c=!0:u==="pan-x"?c=b>a:u==="pan-y"&&(c=a>b)),c?n.preventDefault():k("track")}}(t)}if(e=t[S],!e.skip){for(let o,n=0;n<v.length;n++)o=v[n],r[o.name]&&!e[o.name]&&o.flow&&o.flow.start.indexOf(t.type)>-1&&o.reset&&o.reset();for(let o,n=0;n<v.length;n++)o=v[n],r[o.name]&&!e[o.name]&&(e[o.name]=!0,o[i](t))}}}function De(t,e,i){return!!y[e]&&(function(s,r,o){let n=y[r],h=n.deps,l=n.name,u=s[D];u||(s[D]=u={});for(let c,a,b=0;b<h.length;b++)c=h[b],qe&&ie(c)&&c!=="click"||(a=u[c],a||(u[c]=a={_count:0}),a._count===0&&s.addEventListener(c,re,void 0),a[l]=(a[l]||0)+1,a._count=(a._count||0)+1);s.addEventListener(r,o),n.touchAction&&Be(s,n.touchAction)}(t,e,i),!0)}function Me(t,e,i){return!!y[e]&&(function(s,r,o){let n=y[r],h=n.deps,l=n.name,u=s[D];if(u)for(let c,a,b=0;b<h.length;b++)c=h[b],a=u[c],a&&a[l]&&(a[l]=(a[l]||1)-1,a._count=(a._count||1)-1,a._count===0&&s.removeEventListener(c,re,void 0));s.removeEventListener(r,o)}(t,e,i),!0)}function q(t){v.push(t);for(let e=0;e<t.emits.length;e++)y[t.emits[e]]=t}function Be(t,e){te&&t instanceof HTMLElement&&$e.run(()=>{t.style.touchAction=e}),t[M]=e}function B(t,e,i){let s=new Event(e,{bubbles:!0,cancelable:!0,composed:!0});if(s.detail=i,Ee(t).dispatchEvent(s),s.defaultPrevented){let r=i.preventer||i.sourceEvent;r&&r.preventDefault&&r.preventDefault()}}function k(t){let e=function(i){for(let s,r=0;r<v.length;r++){s=v[r];for(let o,n=0;n<s.emits.length;n++)if(o=s.emits[n],o===i)return s}return null}(t);e.info&&(e.info.prevent=!0)}function _(t,e,i,s){e&&B(e,t,{x:i.clientX,y:i.clientY,sourceEvent:i,preventer:s,prevent:function(r){return k(r)}})}function F(t,e,i){if(t.prevent)return!1;if(t.started)return!0;let s=Math.abs(t.x-e),r=Math.abs(t.y-i);return s>=5||r>=5}function A(t,e,i){if(!e)return;let s,r=t.moves[t.moves.length-2],o=t.moves[t.moves.length-1],n=o.x-t.x,h=o.y-t.y,l=0;r&&(s=o.x-r.x,l=o.y-r.y),B(e,"track",{state:t.state,x:i.clientX,y:i.clientY,dx:n,dy:h,ddx:s,ddy:l,sourceEvent:i,hover:function(){return Le(i.clientX,i.clientY)}})}function V(t,e,i){let s=Math.abs(e.clientX-t.x),r=Math.abs(e.clientY-t.y),o=p(i||e);!o||Ae[o.localName]&&o.hasAttribute("disabled")||(isNaN(s)||isNaN(r)||s<=25&&r<=25||function(n){if(n.type==="click"){if(n.detail===0)return!0;let h=p(n);if(!h.nodeType||h.nodeType!==Node.ELEMENT_NODE)return!0;let l=h.getBoundingClientRect(),u=n.pageX,c=n.pageY;return!(u>=l.left&&u<=l.right&&c>=l.top&&c<=l.bottom)}return!1}(e))&&(t.prevent||B(o,"tap",{x:e.clientX,y:e.clientY,sourceEvent:e,preventer:i}))}q({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset:function(){f(this.info)},mousedown:function(t){if(!g(t))return;let e=p(t),i=this;G(this.info,function(s){g(s)||(_("up",e,s),f(i.info))},function(s){g(s)&&_("up",e,s),f(i.info)}),_("down",e,t)},touchstart:function(t){_("down",p(t),t.changedTouches[0],t)},touchend:function(t){_("up",p(t),t.changedTouches[0],t)}}),q({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove:function(t){this.moves.length>2&&this.moves.shift(),this.moves.push(t)},movefn:null,upfn:null,prevent:!1},reset:function(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,f(this.info)},mousedown:function(t){if(!g(t))return;let e=p(t),i=this,s=function(r){let o=r.clientX,n=r.clientY;F(i.info,o,n)&&(i.info.state=i.info.started?r.type==="mouseup"?"end":"track":"start",i.info.state==="start"&&k("tap"),i.info.addMove({x:o,y:n}),g(r)||(i.info.state="end",f(i.info)),e&&A(i.info,e,r),i.info.started=!0)};G(this.info,s,function(r){i.info.started&&s(r),f(i.info)}),this.info.x=t.clientX,this.info.y=t.clientY},touchstart:function(t){let e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchmove:function(t){let e=p(t),i=t.changedTouches[0],s=i.clientX,r=i.clientY;F(this.info,s,r)&&(this.info.state==="start"&&k("tap"),this.info.addMove({x:s,y:r}),A(this.info,e,i),this.info.state="track",this.info.started=!0)},touchend:function(t){let e=p(t),i=t.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:i.clientX,y:i.clientY}),A(this.info,e,i))}}),q({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset:function(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown:function(t){g(t)&&(this.info.x=t.clientX,this.info.y=t.clientY)},click:function(t){g(t)&&V(this.info,t)},touchstart:function(t){const e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchend:function(t){V(this.info,t.changedTouches[0],t)}});const Pe=$`:host {
...
`;class Z extends E{static get is(){return"blockquote-base-embedded-webview"}static get styles(){return[Oe]}static get properties(){return{heading:{type:String},selected:{type:Number},headingLevel:{type:Number,attribute:"heading-level",reflect:!0},screenSizeSelected:{type:Number,attribute:"screen-size-selected"},limitHeight:{type:Boolean,attribute:"limit-height",reflect:!0}}}constructor(){super(),this.selected=0,this.screenSizeSelected=0,this.headingLevel=1,this.heading="",this.__resetResizing=!1,this.__selectArrow=He,this.__readDataPos={x:0,y:0,resizing:!1,cursor:""},this.limitHeight=!1,this._sources=[{file:"",option:"",description:""}],this._updateSize=this._updateSize.bind(this),this._embeddedResizeRef=we()}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this.shadowRoot.addEventListener("webviewresize",({detail:i})=>{Object.assign(this.__readDataPos,i),this.__resetResizing=!0,(i.cursor==="n"||i.cursor==="ne"||i.cursor==="nw")&&window.scroll({top:Math.abs(parseInt(this.__readDataPos.y,10)+this._controlBottom),left:0,behavior:"smooth"}),this.requestUpdate()});const e=Array.from(this.querySelectorAll("template"));e.length&&(this._sources=e.map(i=>{const{src:s,option:r,description:o}=i.dataset;return{src:s,option:r,description:o}}),this._src=this._sources[this.selected].src)}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.embedded=this.shadowRoot.querySelector('[slot="embedded"]'),this._controlBottom=parseFloat(window.getComputedStyle(this._embeddedResizeRef.value).paddingBottom)}_updateSize({detail:e}){this._embeddedResizeRef.value.style.setProperty("--blockquote-base-embedded-webview-resize-rect-width",`${e.width}px`),this._embeddedResizeRef.value.style.setProperty("--blockquote-base-embedded-webview-resize-rect-height",this.limitHeight?"100%":`${e.height}px`),this.__resetResizing=!1,this.requestUpdate()}get _headingLevel(){return this.headingLevel>=1&&this.headingLevel<=6?this.headingLevel:2}render(){return d` ${this._headerTpl} ${this._mainTpl} ${this._litHtmlRender()}`}_litHtmlRender(){Q(this._lightDomTpl,this)}get _lightDomTpl(){return this.embedded}get _headerTpl(){return d`
    ...
    `}get _externalLinkTpl(){return d`<a href="${this._src}" target="_blank" class="open-externally">
      ...
      ><span aria-hidden="true">${Ie}</span></a
