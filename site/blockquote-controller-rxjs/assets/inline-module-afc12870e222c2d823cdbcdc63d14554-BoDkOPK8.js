var $=Object.defineProperty;var R=(s,i,e)=>i in s?$(s,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[i]=e;var h=(s,i,e)=>R(s,typeof i!="symbol"?i+"":i,e);import{T as y,i as v,s as _,x as n,j as k}from"./lit-element-CH2uaVH_.js";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const E={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},q=s=>(...i)=>({_$litDirective$:s,values:i});class T{constructor(i){}get _$AU(){return this._$AM._$AU}_$AT(i,e,t){this._$Ct=i,this._$AM=e,this._$Ci=t}_$AS(i,e){return this.update(i,e)}update(i,e){return this.render(...e)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const b=(s,i)=>{var t;const e=s._$AN;if(e===void 0)return!1;for(const r of e)(t=r._$AO)==null||t.call(r,i,!1),b(r,i);return!0},w=s=>{let i,e;do{if((i=s._$AM)===void 0)break;e=i._$AN,e.delete(s),s=i}while((e==null?void 0:e.size)===0)},x=s=>{for(let i;i=s._$AM;s=i){let e=i._$AN;if(e===void 0)i._$AN=e=new Set;else if(e.has(s))break;e.add(s),B(i)}};function S(s){this._$AN!==void 0?(w(this),this._$AM=s,x(this)):this._$AM=s}function A(s,i=!1,e=0){const t=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(i)if(Array.isArray(t))for(let o=e;o<t.length;o++)b(t[o],!1),w(t[o]);else t!=null&&(b(t,!1),w(t));else b(this,s)}const B=s=>{var i,e;s.type==E.CHILD&&((i=s._$AP)!=null||(s._$AP=A),(e=s._$AQ)!=null||(s._$AQ=S))};class L extends T{constructor(){super(...arguments),this._$AN=void 0}_$AT(i,e,t){super._$AT(i,e,t),x(this),this.isConnected=i._$AU}_$AO(i,e=!0){var t,r;i!==this.isConnected&&(this.isConnected=i,i?(t=this.reconnected)==null||t.call(this):(r=this.disconnected)==null||r.call(this)),e&&(b(this,i),w(this))}setValue(i){if(C(this._$Ct))this._$Ct._$AI(i,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=i,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
