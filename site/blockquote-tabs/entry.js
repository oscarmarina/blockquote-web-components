...
`,$e=class extends M{static get styles(){return[Qe]}static get properties(){return{screenSizes:{type:Array,attribute:`screen-sizes`},selected:{type:Number},widthInPercent:{type:Boolean,attribute:`width-in-percent`},showOverflowSize:{type:Boolean,attribute:`show-overflow-size`},disabledSelectedSizeText:{type:Boolean,attribute:`disabled-selected-size-text`}}}constructor(){super(),this._onResize=e=>{e.preventDefault(),e.stopPropagation(),window.requestAnimationFrame(()=>{this.requestUpdate()})},this.showOverflowSize=!1,this.selected=0,this.disabledSelectedSizeText=!1,this.screenSizes=[{width:360,height:800,id:`360x800`},{width:390,height:864,id:`390x864`},{width:414,height:896,id:`414x896`},{width:768,height:1024,id:`768x1024`},{width:810,height:1080,id:`810x1080`},{width:1280,height:720,id:`1280x800`},{width:1366,height:768,id:`1366x768`},{width:1536,height:864,id:`1536x864`},{width:1920,height:1080,id:`1920x1080`}],this.widthInPercent=!1}get selectedSize(){return this.screenSizes[this.selected-1]}get selectedDetail(){return{...this.selectedSize,index:this.selected}}get computedStyleWidth(){return parseInt(window.getComputedStyle(this).width,10)}connectedCallback(){super.connectedCallback&&super.connectedCallback(),window.addEventListener(`resize`,this._onResize)}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),window.removeEventListener(`resize`,this._onResize)}willUpdate(e){super.willUpdate&&super.willUpdate(e),e.has(`screenSizes`)&&this.screenSizes.sort((e,t)=>t.width-e.width),e.has(`selected`)&&(this.selected>this.screenSizes.length||this.selected===0)&&(this.selected=this.screenSizes.length)}updated(e){if(super.updated&&super.updated(e),e.has(`selected`)){let e=new CustomEvent(`selectedchange`,{bubbles:!0,detail:this.selectedDetail});this.dispatchEvent(e)}}render(){return w`
    ...
    `}_setSelected(e){e.preventDefault(),e.stopPropagation(),this.selected=Number(e.target.dataset.index);let t=new CustomEvent(`click`,{detail:this.selectedDetail});this.dispatchEvent(t)}};window.customElements.define(`blockquote-base-embedded-webview-size`,$e);var et=o`
  :host {
...
`,st=class extends M{static get styles(){return[it]}static get properties(){return{heading:{type:String},selected:{type:Number},headingLevel:{type:Number,attribute:`heading-level`,reflect:!0,useDefault:!0},screenSizeSelected:{type:Number,attribute:`screen-size-selected`},limitHeight:{type:Boolean,attribute:`limit-height`,reflect:!0,useDefault:!0}}}constructor(){super(),this.__resetResizing=!1,this.__selectArrow=at,this.__readDataPos={x:`0`,y:`0`,resizing:!1,cursor:``},this._embeddedResizeRef=F(),this._updateSize=({detail:e})=>{var t,n;(t=this._embeddedResizeRef)==null||(t=t.value)==null||t.style.setProperty(`--blockquote-base-embedded-webview-resize-rect-width`,`${e.width}px`),(n=this._embeddedResizeRef)==null||(n=n.value)==null||n.style.setProperty(`--blockquote-base-embedded-webview-resize-rect-height`,this.limitHeight?`100%`:`${e.height}px`),this.__resetResizing=!1,this.requestUpdate()},this.selected=0,this.screenSizeSelected=0,this.headingLevel=1,this.heading=``,this.__resetResizing=!1,this.__selectArrow=at,this.__readDataPos={x:`0`,y:`0`,resizing:!1,cursor:``},this.limitHeight=!1,this._sources=[{src:``,option:``,description:``}],this._embeddedResizeRef=F()}async connectedCallback(){var e,t;(e=super.connectedCallback)==null||e.call(this),await this.updateComplete,this.addEventListener(`webviewresize`,e=>{let{detail:t}=e;if(Object.assign(this.__readDataPos,t),this.__resetResizing=!0,t.cursor===`n`||t.cursor===`ne`||t.cursor===`nw`){var n;window.scroll({top:Math.abs(parseInt(this.__readDataPos.y,10)+((n=this._controlBottom)==null?0:n)),left:0,behavior:`smooth`})}this.requestUpdate()});let n=Array.from(this.querySelectorAll(`template`));n.length&&(this._sources=n.map(e=>{let{src:t=``,option:n=``,description:r=``}=e.dataset;return{src:t,option:n,description:r}}),this._src=this._sources[this.selected].src),this.embedded=(t=this.shadowRoot)==null?void 0:t.querySelector(`[slot="embedded"]`),this._embeddedResizeRef.value&&(this._controlBottom=parseFloat(window.getComputedStyle(this._embeddedResizeRef.value).paddingBottom))}get _headingLevel(){return this.headingLevel>=1&&this.headingLevel<=6?this.headingLevel:2}render(){return w`
    ...
    `}_onChangeFile({target:e}){this.selected=e.selectedIndex,this._src=this._sources[this.selected].src}};window.customElements.define(`blockquote-base-embedded-webview`,st);var ct=new WeakMap;function lt(e,t){let n=t;for(;n;){if(ct.get(n)===e)return!0;n=Object.getPrototypeOf(n)}return!1}function ut(e){return t=>{if(lt(e,t))return t;let n=e(t);return ct.set(n,e),n}}function dt(e,t){if(t.has(e))throw TypeError(`Cannot initialize the same private elements twice on an object`)}function I(e,t){dt(e,t),t.add(e)}function L(e,t,n){dt(e,t),t.set(e,n)}function R(e,t,n){if(typeof e==`function`?e===t:e.has(t))return arguments.length<3?t:n;throw TypeError(`Private element is not present on this object`)}function z(e,t){return e.get(R(e,t))}var ft=e=>{var t;return!(e!=null&&(t=e.textContent)!=null&&t.trim())},pt=e=>e.nodeType===Node.COMMENT_NODE||e.nodeType===Node.TEXT_NODE&&ft(e),mt=e=>{var t,n;return t=new WeakSet,n=new WeakMap,class extends e{constructor(...e){super(...e),I(this,t),L(this,n,e=>{var n,r;let i=e.target;if(!(i instanceof HTMLSlotElement))return;let a=i.name||i.getAttribute(`name`)||``,o=i.assignedNodes({flatten:!0}),s=R(t,this,ht).call(this,i),c={hasComposed:s.flattenedContent.length>0,isFallback:s.flattenedContent.some(e=>e.isFallback),assignedSlotContent:{slotName:a,assignedSlot:((n=s.assignedContent[0])==null?void 0:n.assignedSlot)||null},assignedNodesContent:R(t,this,gt).call(this,s.assignedContent),fallbackNodesContent:R(t,this,gt).call(this,s.fallbackContent),flattenedNodesContent:R(t,this,gt).call(this,s.flattenedContent),originalEvent:{event:e,assignedNodes:o}},l=new CustomEvent(`slotchanges`,{composed:!0,detail:c});(r=this.shadowRoot)==null||r.dispatchEvent(l)})}connectedCallback(){var e,t;(e=super.connectedCallback)==null||e.call(this),(t=this.shadowRoot)==null||t.addEventListener(`slotchange`,z(n,this))}disconnectedCallback(){var e,t;(e=super.disconnectedCallback)==null||e.call(this),(t=this.shadowRoot)==null||t.removeEventListener(`slotchange`,z(n,this))}}};function ht(e){let t=e.assignedNodes().filter(e=>!pt(e)),n=t.length>0,r=Array.from(e.childNodes).filter(e=>!pt(e)),i=e.assignedSlot===null,a=t.map(e=>{var t;return{isFlattened:i,hasComposed:i,isFallback:!1,assignedNodes:e.nodeType===Node.TEXT_NODE?(t=e.textContent)==null?void 0:t.trim():e,assignedSlot:`assignedSlot`in e?e.assignedSlot:null}}),o=r.map(e=>{var t;return{isFlattened:i,hasComposed:i,isFallback:!0,assignedNodes:e.nodeType===Node.TEXT_NODE?(t=e.textContent)==null?void 0:t.trim():e,assignedSlot:`assignedSlot`in e?e.assignedSlot:null}});return{assignedContent:a,fallbackContent:o,flattenedContent:(n?a:o).filter(e=>e.isFlattened)}}function gt(e){return{assignedNodesByNode:e,assignedNodes:e.map(e=>e.assignedNodes)}}var _t=ut(mt);function B(e,t,n){return e.set(R(e,t),n),n}var vt=0,yt=()=>`bq-tabs-${vt+=1}`,bt=(e,t)=>{let n=Number.isFinite(e)?Math.trunc(e):1;return t>0?Math.min(Math.max(n,1),t):Math.max(n,1)},V=new WeakMap,H=new WeakMap,U=new WeakMap,xt=new WeakMap,W=new WeakSet,St=class{constructor(e){I(this,W),L(this,V,[]),L(this,H,[]),L(this,U,0),L(this,xt,new Set),this.host=e,e.addController(this)}get length(){return z(V,this).length}get selectedIndex(){return z(U,this)}get selectedIndexFromOne(){return z(U,this)+1}get selectedTab(){return z(V,this)[z(U,this)]}get selectedTabpanel(){return z(H,this)[z(U,this)]}setItems(e=[],t=[]){B(V,this,[...e]),B(H,this,[...t]),R(W,this,wt).call(this);let n=bt(this.host.selected,this.length);if(n!==this.host.selected){this.host.selected=n;return}R(W,this,Ct).call(this,this.host.selected-1)}commit(e){let t=bt(e,this.length);return t===e&&R(W,this,Ct).call(this,t-1),t}};function Ct(e){this.length!==0&&(B(U,this,e),z(V,this).forEach((t,n)=>{t.selected=n===e}),z(H,this).forEach((t,n)=>{t.selected=n===e}))}function wt(){let e=Math.min(z(V,this).length,z(H,this).length);for(let t=0;t<e;t+=1){let e=z(V,this)[t],n=z(H,this)[t];e.id||(e.id=yt()),n.id||(n.id=yt()),e.hasAttribute(`aria-controls`)||e.setAttribute(`aria-controls`,n.id),n.hasAttribute(`aria-labelledby`)||n.setAttribute(`aria-labelledby`,e.id);let r=e.getAttribute(`aria-controls`);R(W,this,Tt).call(this,r!==n.id,`tab "${e.id}" has aria-controls="${r}" but its paired tabpanel has id "${n.id}". Align the ids or remove the attribute to let the component wire the pair.`);let i=n.getAttribute(`aria-labelledby`);R(W,this,Tt).call(this,i!==e.id,`tabpanel "${n.id}" has aria-labelledby="${i}" but its paired tab has id "${e.id}". Align the ids or remove the attribute to let the component wire the pair.`)}}function Tt(e,t){!e||z(xt,this).has(t)||(z(xt,this).add(t),console.warn(`[blockquote-tabs] ${t}`))}var G=new WeakMap,K=new WeakMap,Et=new WeakMap,Dt=new WeakSet,Ot=new WeakMap,kt=class{constructor({getItems:e,getOrientation:t}){I(this,Dt),L(this,G,null),L(this,K,void 0),L(this,Et,void 0),L(this,Ot,e=>{let t=z(K,this).call(this);if(t.length===0)return;let n=e.composedPath().find(e=>t.includes(e));if(!n)return;let r=t.indexOf(n),i=R(Dt,this,At).call(this,r,e.key);if(i===null)return;let a=t[(i+t.length)%t.length];e.preventDefault(),a.focus()}),B(K,this,e),B(Et,this,t)}attach(e){!e||z(G,this)===e||(B(G,this,e),e.addEventListener(`keydown`,z(Ot,this)))}detach(){var e;(e=z(G,this))==null||e.removeEventListener(`keydown`,z(Ot,this)),B(G,this,null)}syncOrientation(){}setEntryItem(e){e&&z(K,this).call(this).forEach(t=>{let n=t===e?`0`:`-1`;t.setAttribute(`tabindex`,n)})}};function At(e,t){let n=z(Et,this).call(this)!==`vertical`,r=z(G,this)!==null&&getComputedStyle(z(G,this)).direction===`rtl`;return t===(n?r?`ArrowLeft`:`ArrowRight`:`ArrowDown`)?e+1:t===(n?r?`ArrowRight`:`ArrowLeft`:`ArrowUp`)?e-1:t===`Home`?0:t===`End`?z(K,this).call(this).length-1:null}var jt=({behavior:e,axis:t,wrap:n,memory:r=!0})=>[e,t,n===!1?`nowrap`:null,r?null:`nomemory`].filter(Boolean).join(` `),q=new WeakMap,Mt=new WeakMap,Nt=new WeakMap,J=new WeakSet,Pt=class{constructor({getItems:e,getOrientation:t}){I(this,J),L(this,q,null),L(this,Mt,void 0),L(this,Nt,void 0),B(Mt,this,e),B(Nt,this,t)}attach(e){!e||z(q,this)===e||(B(q,this,e),R(J,this,Ft).call(this))}detach(){var e;(e=z(q,this))==null||e.removeAttribute(`focusgroup`),B(q,this,null)}syncOrientation(){R(J,this,Ft).call(this)}setEntryItem(e){e&&(R(J,this,Ft).call(this),z(Mt,this).call(this).forEach(t=>{t.toggleAttribute(`focusgroupstart`,t===e)}))}};function Ft(){var e;(e=z(q,this))==null||e.setAttribute(`focusgroup`,jt({behavior:`tablist`,axis:z(Nt,this).call(this)===`vertical`?`block`:void 0,memory:!1}))}var It,Lt=()=>{var e;return(e=It)==null?`focusGroup`in HTMLElement.prototype&&`focusGroupStart`in HTMLElement.prototype:e},Rt=(e,t)=>e.composedPath().find(e=>t.includes(e)),zt=e=>e.hasAttribute(`disabled`)||e.getAttribute(`aria-disabled`)===`true`||!!e.disabled,Y=new WeakMap,X=new WeakMap,Z=new WeakMap,Bt=new WeakMap,Vt=new WeakMap,Q=new WeakMap,Ht=new WeakMap,Ut=new WeakMap,Wt=new WeakMap,Gt=new WeakMap,Kt=class{constructor(e,{getItems:t,getSelectedIndex:n,getOrientation:r,getActivation:i,onSelect:a,onReveal:o}){L(this,Y,null),L(this,X,void 0),L(this,Z,void 0),L(this,Bt,void 0),L(this,Vt,void 0),L(this,Q,void 0),L(this,Ht,void 0),L(this,Ut,e=>{let t=Rt(e,z(Z,this).call(this));if(!(!t||zt(t))&&(z(Ht,this).call(this,t),z(Vt,this).call(this)===`auto`)){let e=z(Z,this).call(this).indexOf(t);z(Q,this).call(this,e)}}),L(this,Wt,e=>{let t=Rt(e,z(Z,this).call(this));if(!t)return;if(zt(t)){e.preventDefault();return}t.focus();let n=z(Z,this).call(this).indexOf(t);if(n===z(Bt,this).call(this)){z(Ht,this).call(this,t);return}z(Q,this).call(this,n)}),L(this,Gt,e=>{if(e.key!==`Enter`&&e.key!==` `)return;let t=Rt(e,z(Z,this).call(this));if(!t||zt(t))return;e.preventDefault();let n=z(Z,this).call(this).indexOf(t);z(Q,this).call(this,n)}),this.host=e,B(Z,this,t),B(Bt,this,n),B(Vt,this,i),B(Q,this,a),B(Ht,this,o);let s={getItems:t,getOrientation:r};B(X,this,Lt()?new Pt(s):new kt(s)),e.addController(this)}get entryItem(){return z(Z,this).call(this)[z(Bt,this).call(this)]}hostConnected(){var e;let t=(e=this.host.shadowRoot)==null?void 0:e.querySelector(`[role="tablist"]`);t&&this.attach(t)}hostDisconnected(){var e,t,n;(e=z(Y,this))==null||e.removeEventListener(`keydown`,z(Gt,this)),(t=z(Y,this))==null||t.removeEventListener(`click`,z(Wt,this)),(n=z(Y,this))==null||n.removeEventListener(`focusin`,z(Ut,this)),B(Y,this,null),z(X,this).detach()}attach(e){!e||z(Y,this)===e||(B(Y,this,e),e.addEventListener(`keydown`,z(Gt,this)),e.addEventListener(`click`,z(Wt,this)),e.addEventListener(`focusin`,z(Ut,this)),z(X,this).attach(e),this.syncEntryPoint())}syncOrientation(){z(X,this).syncOrientation()}syncEntryPoint(){z(X,this).setEntryItem(this.entryItem)}},qt=class{constructor(e,{target:t,config:n,callback:r,skipInitial:i}){this.t=new Set,this.o=!1,this.i=!1,this.h=e,t!==null&&this.t.add(t==null?e:t),this.l=n,this.o=i==null?this.o:i,this.callback=r,window.ResizeObserver?(this.u=new ResizeObserver(e=>{this.handleChanges(e),this.h.requestUpdate()}),e.addController(this)):console.warn(`ResizeController error: browser does not support ResizeObserver.`)}handleChanges(e){var t;this.value=(t=this.callback)==null?void 0:t.call(this,e,this.u)}hostConnected(){for(let e of this.t)this.observe(e)}hostDisconnected(){this.disconnect()}async hostUpdated(){!this.o&&this.i&&this.handleChanges([]),this.i=!1}observe(e){this.t.add(e),this.u.observe(e,this.l),this.i=!0,this.h.requestUpdate()}unobserve(e){this.t.delete(e),this.u.unobserve(e)}disconnect(){this.u.disconnect()}target(e){return Jt(this,e)}},Jt=He(class extends Je{constructor(){super(...arguments),this.observing=!1}render(e,t){}update(e,[t,n]){this.controller=t,this.part=e,this.observe=n,!1===n?(t.unobserve(e.element),this.observing=!1):!1===this.observing&&(t.observe(e.element),this.observing=!0)}disconnected(){var e;(e=this.controller)==null||e.unobserve(this.part.element),this.observing=!1}reconnected(){var e;!1!==this.observe&&!1===this.observing&&((e=this.controller)==null||e.observe(this.part.element),this.observing=!0)}}),$=new WeakMap,Yt=class{constructor(e,{getScrollContent:t,getIndicators:n,getSelectedTab:r,getOrientation:i}){L(this,$,void 0),B($,this,!1),this.hasScrollLeftIndicator=!1,this.hasScrollRightIndicator=!1,this.host=e,this.getScrollContent=t,this.getIndicators=n,this.getSelectedTab=r,this.getOrientation=i==null?(()=>e.orientation===`vertical`?`vertical`:`horizontal`):i,this.hasScrollLeftIndicator=!1,this.hasScrollRightIndicator=!1,new qt(e,{callback:()=>this.onResizeChange(),skipInitial:!0}),e.addController(this)}scrollEdge(e=this.getScrollContent()){if(e){if(this.getOrientation()===`vertical`){let{scrollTop:t,scrollHeight:n,offsetHeight:r}=e,i=n-r,a=t>0,o=t<i;(this.hasScrollLeftIndicator!==a||this.hasScrollRightIndicator!==o)&&(this.hasScrollLeftIndicator=a,this.hasScrollRightIndicator=o,this.host.requestUpdate())}else{let{scrollLeft:t,scrollWidth:n,offsetWidth:r}=e,i=n-r,a=t>0,o=t<i;(this.hasScrollLeftIndicator!==a||this.hasScrollRightIndicator!==o)&&(this.hasScrollLeftIndicator=a,this.hasScrollRightIndicator=o,this.host.requestUpdate())}}}scrollIntoView(e=this.getSelectedTab()){e&&window.requestAnimationFrame(()=>{this.scrollIntoViewWithOffset(e),B($,this,!0)})}scrollIntoViewWithOffset(e=this.getSelectedTab(),t=z($,this)?`smooth`:`auto`){let n=this.getScrollContent();if(!n||!e)return;let r=this.getOrientation()===`vertical`,i=this.getIndicators(),a=i==null?void 0:i[0],o=0;if(a){let e=getComputedStyle(a);o=parseFloat(r?e.blockSize:e.inlineSize)}if(r){let r=e.offsetTop,i=r+e.offsetHeight,a=n.scrollTop;i>a+n.clientHeight?n.scroll({top:i-n.clientHeight+o,behavior:t}):r<a&&n.scroll({top:r-o,behavior:t})}else{let r=e.offsetLeft,i=r+e.offsetWidth,a=n.scrollLeft;i>a+n.clientWidth?n.scroll({left:i-n.clientWidth+o,behavior:t}):r<a&&n.scroll({left:r-o,behavior:t})}}onResizeChange(){this.scrollIntoView(),this.scrollEdge()}},Xt=o`
  :host {
...
`,Zt=class extends _t(M){static get styles(){return[Xt]}static get properties(){return{autofocus:{type:Boolean},label:{type:String},selected:{type:Number,reflect:!0},activation:{type:String},orientation:{type:String,reflect:!0}}}constructor(){super(),this._onSlotChanges=e=>{e.stopPropagation(),e.preventDefault();let{detail:t}=e,n=t.assignedNodesContent.assignedNodes;t.assignedSlotContent.slotName===`tab`&&(this._tabList=n),t.assignedSlotContent.slotName===`tabpanel`&&(this._tabpanelList=n),this._selection.setItems(this._tabList,this._tabpanelList),this._focusGroup.syncEntryPoint()},this.autofocus=!1,this.label=``,this.selected=1,this.activation=`auto`,this.orientation=`horizontal`,this._tabList=[],this._tabpanelList=[],this._scrollContentRef=F(),this._tablistRef=F(),this._selection=new St(this),this._focusGroup=new Kt(this,{getItems:()=>this._tabList,getSelectedIndex:()=>this._selection.selectedIndex,getOrientation:()=>this.orientation===`vertical`?`vertical`:`horizontal`,getActivation:()=>this.activation===`manual`?`manual`:`auto`,onSelect:e=>{this.selected=e+1},onReveal:e=>{this._scroll.scrollIntoView(e)}}),this._scroll=new Yt(this,{getScrollContent:()=>this._scrollContentRef.value,getIndicators:()=>this._indicators,getSelectedTab:()=>this._selectedTab,getOrientation:()=>this.orientation===`vertical`?`vertical`:`horizontal`}),this.addEventListener(`slotchanges`,this._onSlotChanges)}get _selectedTab(){return this._selection.selectedTab}firstUpdated(e){var t,n,r,i;super.firstUpdated(e);let a=(t=this.shadowRoot)==null?void 0:t.querySelector(`[name="tab"]`),o=(n=this.shadowRoot)==null?void 0:n.querySelector(`[name="tabpanel"]`);this._tabList=a==null?void 0:a.assignedElements(),this._tabpanelList=o==null?void 0:o.assignedElements(),this._indicators=(r=this.shadowRoot)==null?void 0:r.querySelectorAll(`.indicator`),this._selection.setItems(this._tabList,this._tabpanelList),this._focusGroup.attach(this._tablistRef.value);let s=(i=this._tabList.find(e=>e.hasAttribute(`autofocus`)))==null?this.autofocus?this._focusGroup.entryItem:void 0:i;s&&window.requestAnimationFrame(()=>s.focus())}updated(e){if(super.updated(e),e.has(`orientation`)&&this._focusGroup.syncOrientation(),e.has(`selected`)){let e=this._selection.commit(this.selected);if(e!==this.selected){this.selected=e;return}this._onSelectionCommit();let t=new CustomEvent(`selectedchange`,{bubbles:!0,detail:{selected:this._selection.selectedIndexFromOne,tab:this._selection.selectedTab,tabpanel:this._selection.selectedTabpanel}});this.dispatchEvent(t)}}get _scrollContentTpl(){return w`
    ...
    `}_scrollEdge(e){this._scroll.scrollEdge(e.target instanceof HTMLElement?e.target:void 0)}_onSelectionCommit(){this._focusGroup.syncEntryPoint(),this._scroll.scrollIntoView()}},Qt=o`
  :host {
    --__color: var(
...
`,nn,rn=class extends M{static get properties(){return{selected:{type:Boolean}}}static get styles(){return[tn]}constructor(){super(),this.selected=!1}connectedCallback(){var e;(e=super.connectedCallback)==null||e.call(this),this._syncRootAttributes()}updated(e){var t;(t=super.updated)==null||t.call(this,e),this._shouldSyncState(e)&&this._syncState()}render(){return w`
      <slot></slot>
    `}_shouldSyncState(e){return[`selected`].some(t=>e.has(t))}_syncState(){this.hidden=!this.selected,this._setAttributes({"aria-hidden":this.selected?null:`true`}),this.selected?this._setAttributes({tabindex:0}):this._setAttributes({tabindex:null})}_syncRootAttributes(){let{rootAttributes:e}=this.constructor;this._setAttributes(e)}_setAttributes(e={}){for(let[t,n]of Object.entries(e))n===!1||n==null?this.removeAttribute(t):this.setAttribute(t,String(n))}};nn=rn,nn.rootAttributes={role:`tabpanel`,slot:`tabpanel`,tabindex:0},window.customElements.define(`blockquote-tabpanel`,rn),window.customElements.define(`blockquote-tabs`,Zt);