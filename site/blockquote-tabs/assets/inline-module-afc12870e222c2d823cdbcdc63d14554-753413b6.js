var ee=Object.defineProperty,te=Object.defineProperties;var ie=Object.getOwnPropertyDescriptors;var P=Object.getOwnPropertySymbols;var re=Object.prototype.hasOwnProperty,se=Object.prototype.propertyIsEnumerable;var O=(t,e,i)=>e in t?ee(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,A=(t,e)=>{for(var i in e||(e={}))re.call(e,i)&&O(t,i,e[i]);if(P)for(var i of P(e))se.call(e,i)&&O(t,i,e[i]);return t},N=(t,e)=>te(t,ie(e));import{i as x,s as k,x as d,e as oe,n as ne}from"./ref-9436637f.js";const de=x`:host {
...
button[data-selected] ~ button:hover {
  background-color: var(--_button-bgcolor-selected-hover);
    ...
    >`}_onResize(e){e.preventDefault(),e.stopPropagation(),window.requestAnimationFrame(()=>{this.requestUpdate()})}_setSelected(e){e.preventDefault(),e.stopPropagation(),this.selected=Number(e.target.dataset.index);const i=new CustomEvent("click",{detail:this.selectedDetail});this.dispatchEvent(i)}}window.customElements.define(Y.is,Y);/**
@license
...
*/let ae=0,W=0,v=[],ce=0,q=!1,j=document.createTextNode("");new window.MutationObserver(function(){q=!1;const t=v.length;for(let e=0;e<t;e++){let i=v[e];if(i)try{i()}catch(r){setTimeout(()=>{throw r})}}v.splice(0,t),W+=t}).observe(j,{characterData:!0});const le={run:t=>(q||(q=!0,j.textContent=ce++),v.push(t),ae++),cancel(t){const e=t-W;if(e>=0){if(!v[e])throw new Error("invalid async handle: "+t);v[e]=null}}};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let G=typeof document.head.style.touchAction=="string",T="__polymerGestures",S="__polymerGesturesHandled",L="__polymerGesturesTouchAction",ue=["mousedown","mousemove","mouseup","click"],be=[0,1,4,2],me=function(){try{return new MouseEvent("test",{buttons:1}).buttons===1}catch(t){return!1}}();function Z(t){return ue.indexOf(t)>-1}let pe=!1;(function(){try{let t=Object.defineProperty({},"passive",{get(){pe=!0}});window.addEventListener("test",null,t),window.removeEventListener("test",null,t)}catch(t){}})();let ge=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/);const we={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};function g(t){let e=t.type;if(!Z(e))return!1;if(e==="mousemove"){let i=t.buttons===void 0?1:t.buttons;return t instanceof window.MouseEvent&&!me&&(i=be[t.which]||0),!!(1&i)}return(t.button===void 0?0:t.button)===0}let m={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};function H(t,e,i){t.movefn=e,t.upfn=i,document.addEventListener("mousemove",e),document.addEventListener("mouseup",i)}function f(t){document.removeEventListener("mousemove",t.movefn),document.removeEventListener("mouseup",t.upfn),t.movefn=null,t.upfn=null}const J=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:t=>t.composedPath&&t.composedPath()||[],z={},w=[];function fe(t,e){let i=document.elementFromPoint(t,e),r=i;for(;r&&r.shadowRoot&&!window.ShadyDOM;){let s=r;if(r=r.shadowRoot.elementFromPoint(t,e),s===r)break;r&&(i=r)}return i}function p(t){const e=J(t);return e.length>0?e[0]:t.target}function K(t){let e,i=t.type,r=t.currentTarget.__polymerGestures;if(!r)return;let s=r[i];if(s){if(!t[S]&&(t[S]={},i.slice(0,5)==="touch")){let o=t.changedTouches[0];if(i==="touchstart"&&t.touches.length===1&&(m.touch.id=o.identifier),m.touch.id!==o.identifier)return;G||i!=="touchstart"&&i!=="touchmove"||function(n){let h=n.changedTouches[0],l=n.type;if(l==="touchstart")m.touch.x=h.clientX,m.touch.y=h.clientY,m.touch.scrollDecided=!1;else if(l==="touchmove"){if(m.touch.scrollDecided)return;m.touch.scrollDecided=!0;let u=function(Q){let B="auto",M=J(Q);for(let E,R=0;R<M.length;R++)if(E=M[R],E[L]){B=E[L];break}return B}(n),c=!1,a=Math.abs(m.touch.x-h.clientX),b=Math.abs(m.touch.y-h.clientY);n.cancelable&&(u==="none"?c=!0:u==="pan-x"?c=b>a:u==="pan-y"&&(c=a>b)),c?n.preventDefault():y("track")}}(t)}if(e=t[S],!e.skip){for(let o,n=0;n<w.length;n++)o=w[n],s[o.name]&&!e[o.name]&&o.flow&&o.flow.start.indexOf(t.type)>-1&&o.reset&&o.reset();for(let o,n=0;n<w.length;n++)o=w[n],s[o.name]&&!e[o.name]&&(e[o.name]=!0,o[i](t))}}}function ve(t,e,i){return!!z[e]&&(function(r,s,o){let n=z[s],h=n.deps,l=n.name,u=r[T];u||(r[T]=u={});for(let c,a,b=0;b<h.length;b++)c=h[b],ge&&Z(c)&&c!=="click"||(a=u[c],a||(u[c]=a={_count:0}),a._count===0&&r.addEventListener(c,K,void 0),a[l]=(a[l]||0)+1,a._count=(a._count||0)+1);r.addEventListener(s,o),n.touchAction&&ze(r,n.touchAction)}(t,e,i),!0)}function _e(t,e,i){return!!z[e]&&(function(r,s,o){let n=z[s],h=n.deps,l=n.name,u=r[T];if(u)for(let c,a,b=0;b<h.length;b++)c=h[b],a=u[c],a&&a[l]&&(a[l]=(a[l]||1)-1,a._count=(a._count||1)-1,a._count===0&&r.removeEventListener(c,K,void 0));r.removeEventListener(s,o)}(t,e,i),!0)}function C(t){w.push(t);for(let e=0;e<t.emits.length;e++)z[t.emits[e]]=t}function ze(t,e){G&&t instanceof HTMLElement&&le.run(()=>{t.style.touchAction=e}),t[L]=e}function D(t,e,i){let r=new Event(e,{bubbles:!0,cancelable:!0,composed:!0});if(r.detail=i,he(t).dispatchEvent(r),r.defaultPrevented){let s=i.preventer||i.sourceEvent;s&&s.preventDefault&&s.preventDefault()}}function y(t){let e=function(i){for(let r,s=0;s<w.length;s++){r=w[s];for(let o,n=0;n<r.emits.length;n++)if(o=r.emits[n],o===i)return r}return null}(t);e.info&&(e.info.prevent=!0)}function _(t,e,i,r){e&&D(e,t,{x:i.clientX,y:i.clientY,sourceEvent:i,preventer:r,prevent:function(s){return y(s)}})}function X(t,e,i){if(t.prevent)return!1;if(t.started)return!0;let r=Math.abs(t.x-e),s=Math.abs(t.y-i);return r>=5||s>=5}function $(t,e,i){if(!e)return;let r,s=t.moves[t.moves.length-2],o=t.moves[t.moves.length-1],n=o.x-t.x,h=o.y-t.y,l=0;s&&(r=o.x-s.x,l=o.y-s.y),D(e,"track",{state:t.state,x:i.clientX,y:i.clientY,dx:n,dy:h,ddx:r,ddy:l,sourceEvent:i,hover:function(){return fe(i.clientX,i.clientY)}})}function I(t,e,i){let r=Math.abs(e.clientX-t.x),s=Math.abs(e.clientY-t.y),o=p(i||e);!o||we[o.localName]&&o.hasAttribute("disabled")||(isNaN(r)||isNaN(s)||r<=25&&s<=25||function(n){if(n.type==="click"){if(n.detail===0)return!0;let h=p(n);if(!h.nodeType||h.nodeType!==Node.ELEMENT_NODE)return!0;let l=h.getBoundingClientRect(),u=n.pageX,c=n.pageY;return!(u>=l.left&&u<=l.right&&c>=l.top&&c<=l.bottom)}return!1}(e))&&(t.prevent||D(o,"tap",{x:e.clientX,y:e.clientY,sourceEvent:e,preventer:i}))}C({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset:function(){f(this.info)},mousedown:function(t){if(!g(t))return;let e=p(t),i=this;H(this.info,function(r){g(r)||(_("up",e,r),f(i.info))},function(r){g(r)&&_("up",e,r),f(i.info)}),_("down",e,t)},touchstart:function(t){_("down",p(t),t.changedTouches[0],t)},touchend:function(t){_("up",p(t),t.changedTouches[0],t)}}),C({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove:function(t){this.moves.length>2&&this.moves.shift(),this.moves.push(t)},movefn:null,upfn:null,prevent:!1},reset:function(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,f(this.info)},mousedown:function(t){if(!g(t))return;let e=p(t),i=this,r=function(s){let o=s.clientX,n=s.clientY;X(i.info,o,n)&&(i.info.state=i.info.started?s.type==="mouseup"?"end":"track":"start",i.info.state==="start"&&y("tap"),i.info.addMove({x:o,y:n}),g(s)||(i.info.state="end",f(i.info)),e&&$(i.info,e,s),i.info.started=!0)};H(this.info,r,function(s){i.info.started&&r(s),f(i.info)}),this.info.x=t.clientX,this.info.y=t.clientY},touchstart:function(t){let e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchmove:function(t){let e=p(t),i=t.changedTouches[0],r=i.clientX,s=i.clientY;X(this.info,r,s)&&(this.info.state==="start"&&y("tap"),this.info.addMove({x:r,y:s}),$(this.info,e,i),this.info.state="track",this.info.started=!0)},touchend:function(t){let e=p(t),i=t.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:i.clientX,y:i.clientY}),$(this.info,e,i))}}),C({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset:function(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown:function(t){g(t)&&(this.info.x=t.clientX,this.info.y=t.clientY)},click:function(t){g(t)&&I(this.info,t)},touchstart:function(t){const e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchend:function(t){I(this.info,t.changedTouches[0],t)}});const ye=x`:host {
...
`;class V extends k{static get is(){return"blockquote-base-embedded-webview"}static get styles(){return[ke]}static get properties(){return{heading:{type:String},selected:{type:Number},headingLevel:{type:Number,attribute:"heading-level",reflect:!0},screenSizeSelected:{type:Number,attribute:"screen-size-selected"},limitHeight:{type:Boolean,attribute:"limit-height",reflect:!0}}}constructor(){super(),this.selected=0,this.screenSizeSelected=0,this.headingLevel=1,this.heading="",this.__resetResizing=!1,this.__selectArrow=Ee,this.__readDataPos={x:0,y:0,resizing:!1,cursor:""},this.limitHeight=!1,this._sources=[{file:"",option:"",description:""}],this._updateSize=this._updateSize.bind(this),this._embeddedResizeRef=oe()}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this.shadowRoot.addEventListener("webviewresize",({detail:i})=>{Object.assign(this.__readDataPos,i),this.__resetResizing=!0,(i.cursor==="n"||i.cursor==="ne"||i.cursor==="nw")&&window.scroll({top:Math.abs(parseInt(this.__readDataPos.y,10)+this._controlBottom),left:0,behavior:"smooth"}),this.requestUpdate()});const e=Array.from(this.querySelectorAll("template"));e.length&&(this._sources=e.map(i=>{const{src:r,option:s,description:o}=i.dataset;return{src:r,option:s,description:o}}),this._src=this._sources[this.selected].src)}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.embedded=this.shadowRoot.querySelector('[slot="embedded"]'),this._controlBottom=parseFloat(window.getComputedStyle(this._embeddedResizeRef.value).paddingBottom),this.append(this.embedded)}_updateSize({detail:e}){this._embeddedResizeRef.value.style.setProperty("--blockquote-base-embedded-webview-resize-rect-width",`${e.width}px`),this._embeddedResizeRef.value.style.setProperty("--blockquote-base-embedded-webview-resize-rect-height",this.limitHeight?"100%":`${e.height}px`),this.__resetResizing=!1,this.requestUpdate()}get _headingLevel(){return this.headingLevel>=1&&this.headingLevel<=6?this.headingLevel:2}render(){return d` ${this._headerTpl} ${this._mainTpl} `}get _headerTpl(){return d`
    ...
    `}get _externalLinkTpl(){return d`<a href="${this._src}" target="_blank" class="open-externally">
      ...
      ><span aria-hidden="true">${Re}</span></a
