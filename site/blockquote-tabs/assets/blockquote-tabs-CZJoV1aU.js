...
:host(:focus-visible) {
  ...
  outline-offset: -2px;
      ...
      <slot></slot>
    `}__setArrayAttibute(s={}){Object.entries(s).forEach(([e,o])=>{this.setAttribute(e,o)})}}window.customElements.define("blockquote-tabpanel",Ge);window.customElements.define("blockquote-tabs",$e);
