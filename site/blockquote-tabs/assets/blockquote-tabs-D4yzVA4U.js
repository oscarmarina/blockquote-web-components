var de=Object.defineProperty;var he=(t,s,e)=>s in t?de(t,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[s]=e;var m=(t,s,e)=>he(t,typeof s!="symbol"?s+"":s,e);import{i as D,h as P,a as ue,k as v,K as be,D as ve}from"./ref-DSXALG9N.js";var f=[],fe=function(){return f.some(function(t){return t.activeTargets.length>0})},pe=function(){return f.some(function(t){return t.skippedTargets.length>0})},V="ResizeObserver loop completed with undelivered notifications.",ge=function(){var t;typeof ErrorEvent=="function"?t=new ErrorEvent("error",{message:V}):(t=document.createEvent("Event"),t.initEvent("error",!1,!1),t.message=V),window.dispatchEvent(t)},S;(function(t){t.BORDER_BOX="border-box",t.CONTENT_BOX="content-box",t.DEVICE_PIXEL_CONTENT_BOX="device-pixel-content-box"})(S||(S={}));var p=function(t){return Object.freeze(t)},_e=function(){function t(s,e){this.inlineSize=s,this.blockSize=e,p(this)}return t}(),Q=function(){function t(s,e,o,r){return this.x=s,this.y=e,this.width=o,this.height=r,this.top=this.y,this.left=this.x,this.bottom=this.top+this.height,this.right=this.left+this.width,p(this)}return t.prototype.toJSON=function(){var s=this,e=s.x,o=s.y,r=s.top,i=s.right,n=s.bottom,c=s.left,d=s.width,l=s.height;return{x:e,y:o,top:r,right:i,bottom:n,left:c,width:d,height:l}},t.fromRect=function(s){return new t(s.x,s.y,s.width,s.height)},t}(),F=function(t){return t instanceof SVGElement&&"getBBox"in t},Z=function(t){if(F(t)){var s=t.getBBox(),e=s.width,o=s.height;return!e&&!o}var r=t,i=r.offsetWidth,n=r.offsetHeight;return!(i||n||t.getClientRects().length)},U=function(t){var s;if(t instanceof Element)return!0;var e=(s=t==null?void 0:t.ownerDocument)===null||s===void 0?void 0:s.defaultView;return!!(e&&t instanceof e.Element)},we=function(t){switch(t.tagName){case"INPUT":if(t.type!=="image")break;case"VIDEO":case"AUDIO":case"EMBED":case"OBJECT":case"CANVAS":case"IFRAME":case"IMG":return!0}return!1},R=typeof window<"u"?window:{},k=new WeakMap,H=/auto|scroll/,me=/^tb|vertical/,ye=/msie|trident/i.test(R.navigator&&R.navigator.userAgent),b=function(t){return parseFloat(t||"0")},y=function(t,s,e){return t===void 0&&(t=0),s===void 0&&(s=0),e===void 0&&(e=!1),new _e((e?s:t)||0,(e?t:s)||0)},X=p({devicePixelContentBoxSize:y(),borderBoxSize:y(),contentBoxSize:y(),contentRect:new Q(0,0,0,0)}),ee=function(t,s){if(s===void 0&&(s=!1),k.has(t)&&!s)return k.get(t);if(Z(t))return k.set(t,X),X;var e=getComputedStyle(t),o=F(t)&&t.ownerSVGElement&&t.getBBox(),r=!ye&&e.boxSizing==="border-box",i=me.test(e.writingMode||""),n=!o&&H.test(e.overflowY||""),c=!o&&H.test(e.overflowX||""),d=o?0:b(e.paddingTop),l=o?0:b(e.paddingRight),h=o?0:b(e.paddingBottom),u=o?0:b(e.paddingLeft),g=o?0:b(e.borderTopWidth),x=o?0:b(e.borderRightWidth),_=o?0:b(e.borderBottomWidth),T=o?0:b(e.borderLeftWidth),C=u+l,a=d+h,w=T+x,A=g+_,W=c?t.offsetHeight-A-t.clientHeight:0,M=n?t.offsetWidth-w-t.clientWidth:0,ne=r?C+w:0,ae=r?a+A:0,E=o?o.width:b(e.width)-ne-M,O=o?o.height:b(e.height)-ae-W,le=E+C+M+w,ce=O+a+W+A,$=p({devicePixelContentBoxSize:y(Math.round(E*devicePixelRatio),Math.round(O*devicePixelRatio),i),borderBoxSize:y(le,ce,i),contentBoxSize:y(E,O,i),contentRect:new Q(u,d,E,O)});return k.set(t,$),$},te=function(t,s,e){var o=ee(t,e),r=o.borderBoxSize,i=o.contentBoxSize,n=o.devicePixelContentBoxSize;switch(s){case S.DEVICE_PIXEL_CONTENT_BOX:return n;case S.BORDER_BOX:return r;default:return i}},xe=function(){function t(s){var e=ee(s);this.target=s,this.contentRect=e.contentRect,this.borderBoxSize=p([e.borderBoxSize]),this.contentBoxSize=p([e.contentBoxSize]),this.devicePixelContentBoxSize=p([e.devicePixelContentBoxSize])}return t}(),se=function(t){if(Z(t))return 1/0;for(var s=0,e=t.parentNode;e;)s+=1,e=e.parentNode;return s},Te=function(){var t=1/0,s=[];f.forEach(function(n){if(n.activeTargets.length!==0){var c=[];n.activeTargets.forEach(function(l){var h=new xe(l.target),u=se(l.target);c.push(h),l.lastReportedSize=te(l.target,l.observedBox),u<t&&(t=u)}),s.push(function(){n.callback.call(n.observer,c,n.observer)}),n.activeTargets.splice(0,n.activeTargets.length)}});for(var e=0,o=s;e<o.length;e++){var r=o[e];r()}return t},G=function(t){f.forEach(function(e){e.activeTargets.splice(0,e.activeTargets.length),e.skippedTargets.splice(0,e.skippedTargets.length),e.observationTargets.forEach(function(r){r.isActive()&&(se(r.target)>t?e.activeTargets.push(r):e.skippedTargets.push(r))})})},Ce=function(){var t=0;for(G(t);fe();)t=Te(),G(t);return pe()&&ge(),t>0},N,oe=[],Re=function(){return oe.splice(0).forEach(function(t){return t()})},Se=function(t){if(!N){var s=0,e=document.createTextNode(""),o={characterData:!0};new MutationObserver(function(){return Re()}).observe(e,o),N=function(){e.textContent="".concat(s?s--:s++)}}oe.push(t),N()},Ee=function(t){Se(function(){requestAnimationFrame(t)})},L=0,Oe=function(){return!!L},ke=250,ze={attributes:!0,characterData:!0,childList:!0,subtree:!0},K=["resize","load","transitionend","animationend","animationstart","animationiteration","keyup","keydown","mouseup","mousedown","mouseover","mouseout","blur","focus"],j=function(t){return t===void 0&&(t=0),Date.now()+t},I=!1,Be=function(){function t(){var s=this;this.stopped=!0,this.listener=function(){return s.schedule()}}return t.prototype.run=function(s){var e=this;if(s===void 0&&(s=ke),!I){I=!0;var o=j(s);Ee(function(){var r=!1;try{r=Ce()}finally{if(I=!1,s=o-j(),!Oe())return;r?e.run(1e3):s>0?e.run(s):e.start()}})}},t.prototype.schedule=function(){this.stop(),this.run()},t.prototype.observe=function(){var s=this,e=function(){return s.observer&&s.observer.observe(document.body,ze)};document.body?e():R.addEventListener("DOMContentLoaded",e)},t.prototype.start=function(){var s=this;this.stopped&&(this.stopped=!1,this.observer=new MutationObserver(this.listener),this.observe(),K.forEach(function(e){return R.addEventListener(e,s.listener,!0)}))},t.prototype.stop=function(){var s=this;this.stopped||(this.observer&&this.observer.disconnect(),K.forEach(function(e){return R.removeEventListener(e,s.listener,!0)}),this.stopped=!0)},t}(),q=new Be,J=function(t){!L&&t>0&&q.start(),L+=t,!L&&q.stop()},Le=function(t){return!F(t)&&!we(t)&&getComputedStyle(t).display==="inline"},Ae=function(){function t(s,e){this.target=s,this.observedBox=e||S.CONTENT_BOX,this.lastReportedSize={inlineSize:0,blockSize:0}}return t.prototype.isActive=function(){var s=te(this.target,this.observedBox,!0);return Le(this.target)&&(this.lastReportedSize=s),this.lastReportedSize.inlineSize!==s.inlineSize||this.lastReportedSize.blockSize!==s.blockSize},t}(),Ne=function(){function t(s,e){this.activeTargets=[],this.skippedTargets=[],this.observationTargets=[],this.observer=s,this.callback=e}return t}(),z=new WeakMap,Y=function(t,s){for(var e=0;e<t.length;e+=1)if(t[e].target===s)return e;return-1},B=function(){function t(){}return t.connect=function(s,e){var o=new Ne(s,e);z.set(s,o)},t.observe=function(s,e,o){var r=z.get(s),i=r.observationTargets.length===0;Y(r.observationTargets,e)<0&&(i&&f.push(r),r.observationTargets.push(new Ae(e,o&&o.box)),J(1),q.schedule())},t.unobserve=function(s,e){var o=z.get(s),r=Y(o.observationTargets,e),i=o.observationTargets.length===1;r>=0&&(i&&f.splice(f.indexOf(o),1),o.observationTargets.splice(r,1),J(-1))},t.disconnect=function(s){var e=this,o=z.get(s);o.observationTargets.slice().forEach(function(r){return e.unobserve(s,r.target)}),o.activeTargets.splice(0,o.activeTargets.length)},t}(),Ie=function(){function t(s){if(arguments.length===0)throw new TypeError("Failed to construct 'ResizeObserver': 1 argument required, but only 0 present.");if(typeof s!="function")throw new TypeError("Failed to construct 'ResizeObserver': The callback provided as parameter 1 is not a function.");B.connect(this,s)}return t.prototype.observe=function(s,e){if(arguments.length===0)throw new TypeError("Failed to execute 'observe' on 'ResizeObserver': 1 argument required, but only 0 present.");if(!U(s))throw new TypeError("Failed to execute 'observe' on 'ResizeObserver': parameter 1 is not of type 'Element");B.observe(this,s,e)},t.prototype.unobserve=function(s){if(arguments.length===0)throw new TypeError("Failed to execute 'unobserve' on 'ResizeObserver': 1 argument required, but only 0 present.");if(!U(s))throw new TypeError("Failed to execute 'unobserve' on 'ResizeObserver': parameter 1 is not of type 'Element");B.unobserve(this,s)},t.prototype.disconnect=function(){B.disconnect(this)},t.toString=function(){return"function ResizeObserver () { [polyfill code] }"},t}();/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class qe{constructor(s,{target:e,config:o,callback:r,skipInitial:i}){this.t=new Set,this.o=!1,this.i=!1,this.h=s,e!==null&&this.t.add(e!=null?e:s),this.l=o,this.o=i!=null?i:this.o,this.callback=r,window.ResizeObserver?(this.u=new ResizeObserver(n=>{this.handleChanges(n),this.h.requestUpdate()}),s.addController(this)):console.warn("ResizeController error: browser does not support ResizeObserver.")}handleChanges(s){var e;this.value=(e=this.callback)==null?void 0:e.call(this,s,this.u)}hostConnected(){for(const s of this.t)this.observe(s)}hostDisconnected(){this.disconnect()}async hostUpdated(){!this.o&&this.i&&this.handleChanges([]),this.i=!1}observe(s){this.t.add(s),this.u.observe(s,this.l),this.i=!0,this.h.requestUpdate()}unobserve(s){this.t.delete(s),this.u.unobserve(s)}disconnect(){this.u.disconnect()}}const re=new WeakMap;function De(t,s){let e=s;for(;e;){if(re.get(e)===t)return!0;e=Object.getPrototypeOf(e)}return!1}function Pe(t){return s=>{if(De(t,s))return s;const e=t(s);return re.set(e,t),e}}const Fe=t=>{var s;return!/[^\t\n\r ]/.test((s=t==null?void 0:t.textContent)!=null?s:"")},We=t=>t.nodeType===8||t.nodeType===3&&Fe(t),Me=t=>class extends t{constructor(){super(...arguments);m(this,"_onSlotChange",o=>{var C;const{target:r}=o,i=r;if(!i)return;const n=i.name||i.getAttribute("name")||"",c=[...i.assignedNodes(),...i.childNodes],d=i.assignedNodes({flatten:!0}),l=[];c.length&&c.forEach(a=>{var w;We(a)||l.push({flatten:a.assignedSlot===null,assignedNodes:a.nodeType===3?(w=a.textContent)==null?void 0:w.trim():a,assignedSlot:a.assignedSlot})});const h=l.filter(a=>a.flatten===!1),u=l.filter(a=>a.flatten===!0),g={assignedNodesByNode:h,assignedNodes:h.map(a=>a.assignedNodes)},x={assignedNodesByNode:u,assignedNodes:u.map(a=>a.assignedNodes)},_={slotName:n,assignedSlot:((C=h[0])==null?void 0:C.assignedSlot)||null},T=new CustomEvent("slotchanges",{composed:!0,detail:{assignedSlotContent:_,assignedNodesContent:g,flattenedNodesContent:x,originalEvent:{event:o,assignedNodes:d}}});this.shadowRoot.dispatchEvent(T)})}connectedCallback(){var o;(o=super.connectedCallback)==null||o.call(this),this.shadowRoot.addEventListener("slotchange",this._onSlotChange)}disconnectedCallback(){var o;(o=super.disconnectedCallback)==null||o.call(this),this.shadowRoot.removeEventListener("slotchange",this._onSlotChange)}},ie=Pe(Me),$e=D`:host {
