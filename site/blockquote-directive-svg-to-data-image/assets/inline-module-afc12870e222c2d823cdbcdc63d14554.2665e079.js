var te=Object.defineProperty,ie=Object.defineProperties;var se=Object.getOwnPropertyDescriptors;var D=Object.getOwnPropertySymbols;var re=Object.prototype.hasOwnProperty,oe=Object.prototype.propertyIsEnumerable;var N=(e,t,i)=>t in e?te(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i,M=(e,t)=>{for(var i in t||(t={}))re.call(t,i)&&N(e,i,t[i]);if(D)for(var i of D(t))oe.call(t,i)&&N(e,i,t[i]);return e},P=(e,t)=>ie(e,se(t));import{i as ne,c as de,t as ae,e as ce,d as B,b as k,s as x,y as l,w as le}from"./directive-helpers.d0d4c120.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const w=(e,t)=>{var i,s;const r=e._$AN;if(r===void 0)return!1;for(const n of r)(s=(i=n)._$AO)===null||s===void 0||s.call(i,t,!1),w(n,t);return!0},_=e=>{let t,i;do{if((t=e._$AM)===void 0)break;i=t._$AN,i.delete(e),e=t}while((i==null?void 0:i.size)===0)},j=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(i===void 0)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),be(t)}};function he(e){this._$AN!==void 0?(_(this),this._$AM=e,j(this)):this._$AM=e}function ue(e,t=!1,i=0){const s=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(s))for(let n=i;n<s.length;n++)w(s[n],!1),_(s[n]);else s!=null&&(w(s,!1),_(s));else w(this,e)}const be=e=>{var t,i,s,r;e.type==ae.CHILD&&((t=(s=e)._$AP)!==null&&t!==void 0||(s._$AP=ue),(i=(r=e)._$AQ)!==null&&i!==void 0||(r._$AQ=he))};class me extends ne{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,i,s){super._$AT(t,i,s),j(this),this.isConnected=t._$AU}_$AO(t,i=!0){var s,r;t!==this.isConnected&&(this.isConnected=t,t?(s=this.reconnected)===null||s===void 0||s.call(this):(r=this.disconnected)===null||r===void 0||r.call(this)),i&&(w(this,t),_(this))}setValue(t){if(de(this._$Ct))this._$Ct._$AI(t,this);else{const i=[...this._$Ct._$AH];i[this._$Ci]=t,this._$Ct._$AI(i,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
...
}`;class O extends x{static get is(){return"blockquote-base-embedded-webview-size"}static get styles(){return[we]}static get properties(){return{screenSizes:{type:Array,attribute:"screen-sizes"},selected:{type:Number},widthInPercent:{type:Boolean,attribute:"width-in-percent"},showOverflowSize:{type:Boolean,attribute:"show-overflow-size"}}}constructor(){super(),this.showOverflowSize=!1,this.selected=0,this.screenSizes=[{width:360,height:640,id:"360x640"},{width:375,height:667,id:"375x667"},{width:414,height:896,id:"414x896"},{width:768,height:1024,id:"768x1024"},{width:1024,height:768,id:"1024x768"},{width:1280,height:800,id:"1280x800"},{width:1366,height:768,id:"1366x768"},{width:1536,height:864,id:"1536x864"},{width:1920,height:1080,id:"1920x1080"}],this.widthInPercent=!1,this._onResize=this._onResize.bind(this)}get selectedSize(){return this.screenSizes[this.selected-1]}get selectedDetail(){return P(M({},this.selectedSize),{index:this.selected})}get computedStyleWidth(){return parseInt(window.getComputedStyle(this).width,10)}connectedCallback(){super.connectedCallback&&super.connectedCallback(),window.addEventListener("resize",this._onResize)}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),window.removeEventListener("resize",this._onResize)}willUpdate(t){super.willUpdate&&super.willUpdate(t),t.has("screenSizes")&&this.screenSizes.sort((i,s)=>s.width-i.width),t.has("selected")&&(this.selected>this.screenSizes.length||this.selected===0)&&(this.selected=this.screenSizes.length)}updated(t){if(super.updated&&super.updated(t),t.has("selected")){const i=new CustomEvent("selectedchange",{bubbles:!0,detail:this.selectedDetail});this.dispatchEvent(i)}}render(){return l`
      <div class="rect">
        ${this._toolbarTpl}
        ${this._visualTextTpl}
        </div>
      </div>
    `}get _toolbarTpl(){return l`
      ${this.screenSizes.map((t,i)=>l`<button
...
*/let ve=0,G=0,f=[],_e=0,$=!1,V=document.createTextNode("");new window.MutationObserver(ze).observe(V,{characterData:!0});function ze(){$=!1;const e=f.length;for(let t=0;t<e;t++){let i=f[t];if(i)try{i()}catch(s){setTimeout(()=>{throw s})}}f.splice(0,e),G+=e}const ye={run(e){return $||($=!0,V.textContent=_e++),f.push(e),ve++},cancel(e){const t=e-G;if(t>=0){if(!f[t])throw new Error("invalid async handle: "+e);f[t]=null}}};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let xe=!1,T=typeof document.head.style.touchAction=="string",z="__polymerGestures",R="__polymerGesturesHandled",S="__polymerGesturesTouchAction",Y=25,H=5,Ee=2,Re=["mousedown","mousemove","mouseup","click"],Ce=[0,1,4,2],$e=function(){try{return new MouseEvent("test",{buttons:1}).buttons===1}catch(e){return!1}}();function A(e){return Re.indexOf(e)>-1}let K=!1;(function(){try{let e=Object.defineProperty({},"passive",{get(){K=!0}});window.addEventListener("test",null,e),window.removeEventListener("test",null,e)}catch(e){}})();function J(e){if(!(A(e)||e==="touchend")&&T&&K&&xe)return{passive:!0}}let Se=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/);const Te={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};function m(e){let t=e.type;if(!A(t))return!1;if(t==="mousemove"){let i=e.buttons===void 0?1:e.buttons;return e instanceof window.MouseEvent&&!$e&&(i=Ce[e.which]||0),Boolean(i&1)}else return(e.button===void 0?0:e.button)===0}function Ae(e){if(e.type==="click"){if(e.detail===0)return!0;let t=u(e);if(!t.nodeType||t.nodeType!==Node.ELEMENT_NODE)return!0;let i=t.getBoundingClientRect(),s=e.pageX,r=e.pageY;return!(s>=i.left&&s<=i.right&&r>=i.top&&r<=i.bottom)}return!1}let h={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};function qe(e){let t="auto",i=Z(e);for(let s=0,r;s<i.length;s++)if(r=i[s],r[S]){t=r[S];break}return t}function Q(e,t,i){e.movefn=t,e.upfn=i,document.addEventListener("mousemove",t),document.addEventListener("mouseup",i)}function p(e){document.removeEventListener("mousemove",e.movefn),document.removeEventListener("mouseup",e.upfn),e.movefn=null,e.upfn=null}const Z=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:e=>e.composedPath&&e.composedPath()||[],v={},b=[];function Le(e,t){let i=document.elementFromPoint(e,t),s=i;for(;s&&s.shadowRoot&&!window.ShadyDOM;){let r=s;if(s=s.shadowRoot.elementFromPoint(e,t),r===s)break;s&&(i=s)}return i}function u(e){const t=Z(e);return t.length>0?t[0]:e.target}function ee(e){let t,i=e.type,r=e.currentTarget[z];if(!r)return;let n=r[i];if(!!n){if(!e[R]&&(e[R]={},i.slice(0,5)==="touch")){e=e;let o=e.changedTouches[0];if(i==="touchstart"&&e.touches.length===1&&(h.touch.id=o.identifier),h.touch.id!==o.identifier)return;T||(i==="touchstart"||i==="touchmove")&&De(e)}if(t=e[R],!t.skip){for(let o=0,d;o<b.length;o++)d=b[o],n[d.name]&&!t[d.name]&&d.flow&&d.flow.start.indexOf(e.type)>-1&&d.reset&&d.reset();for(let o=0,d;o<b.length;o++)d=b[o],n[d.name]&&!t[d.name]&&(t[d.name]=!0,d[i](e))}}}function De(e){let t=e.changedTouches[0],i=e.type;if(i==="touchstart")h.touch.x=t.clientX,h.touch.y=t.clientY,h.touch.scrollDecided=!1;else if(i==="touchmove"){if(h.touch.scrollDecided)return;h.touch.scrollDecided=!0;let s=qe(e),r=!1,n=Math.abs(h.touch.x-t.clientX),o=Math.abs(h.touch.y-t.clientY);e.cancelable&&(s==="none"?r=!0:s==="pan-x"?r=o>n:s==="pan-y"&&(r=n>o)),r?e.preventDefault():y("track")}}function Ne(e,t,i){return v[t]?(Pe(e,t,i),!0):!1}function Me(e,t,i){return v[t]?(Be(e,t,i),!0):!1}function Pe(e,t,i){let s=v[t],r=s.deps,n=s.name,o=e[z];o||(e[z]=o={});for(let d=0,a,c;d<r.length;d++)a=r[d],!(Se&&A(a)&&a!=="click")&&(c=o[a],c||(o[a]=c={_count:0}),c._count===0&&e.addEventListener(a,ee,J(a)),c[n]=(c[n]||0)+1,c._count=(c._count||0)+1);e.addEventListener(t,i),s.touchAction&&Ye(e,s.touchAction)}function Be(e,t,i){let s=v[t],r=s.deps,n=s.name,o=e[z];if(o)for(let d=0,a,c;d<r.length;d++)a=r[d],c=o[a],c&&c[n]&&(c[n]=(c[n]||1)-1,c._count=(c._count||1)-1,c._count===0&&e.removeEventListener(a,ee,J(a)));e.removeEventListener(t,i)}function q(e){b.push(e);for(let t=0;t<e.emits.length;t++)v[e.emits[t]]=e}function Oe(e){for(let t=0,i;t<b.length;t++){i=b[t];for(let s=0,r;s<i.emits.length;s++)if(r=i.emits[s],r===e)return i}return null}function Ye(e,t){T&&e instanceof HTMLElement&&ye.run(()=>{e.style.touchAction=t}),e[S]=t}function L(e,t,i){let s=new Event(t,{bubbles:!0,cancelable:!0,composed:!0});if(s.detail=i,ke(e).dispatchEvent(s),s.defaultPrevented){let r=i.preventer||i.sourceEvent;r&&r.preventDefault&&r.preventDefault()}}function y(e){let t=Oe(e);t.info&&(t.info.prevent=!0)}q({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset:function(){p(this.info)},mousedown:function(e){if(!m(e))return;let t=u(e),i=this,s=function(o){m(o)||(g("up",t,o),p(i.info))},r=function(o){m(o)&&g("up",t,o),p(i.info)};Q(this.info,s,r),g("down",t,e)},touchstart:function(e){g("down",u(e),e.changedTouches[0],e)},touchend:function(e){g("up",u(e),e.changedTouches[0],e)}});function g(e,t,i,s){!t||L(t,e,{x:i.clientX,y:i.clientY,sourceEvent:i,preventer:s,prevent:function(r){return y(r)}})}q({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove:function(e){this.moves.length>Ee&&this.moves.shift(),this.moves.push(e)},movefn:null,upfn:null,prevent:!1},reset:function(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,p(this.info)},mousedown:function(e){if(!m(e))return;let t=u(e),i=this,s=function(o){let d=o.clientX,a=o.clientY;I(i.info,d,a)&&(i.info.state=i.info.started?o.type==="mouseup"?"end":"track":"start",i.info.state==="start"&&y("tap"),i.info.addMove({x:d,y:a}),m(o)||(i.info.state="end",p(i.info)),t&&C(i.info,t,o),i.info.started=!0)},r=function(o){i.info.started&&s(o),p(i.info)};Q(this.info,s,r),this.info.x=e.clientX,this.info.y=e.clientY},touchstart:function(e){let t=e.changedTouches[0];this.info.x=t.clientX,this.info.y=t.clientY},touchmove:function(e){let t=u(e),i=e.changedTouches[0],s=i.clientX,r=i.clientY;I(this.info,s,r)&&(this.info.state==="start"&&y("tap"),this.info.addMove({x:s,y:r}),C(this.info,t,i),this.info.state="track",this.info.started=!0)},touchend:function(e){let t=u(e),i=e.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:i.clientX,y:i.clientY}),C(this.info,t,i))}});function I(e,t,i){if(e.prevent)return!1;if(e.started)return!0;let s=Math.abs(e.x-t),r=Math.abs(e.y-i);return s>=H||r>=H}function C(e,t,i){if(!t)return;let s=e.moves[e.moves.length-2],r=e.moves[e.moves.length-1],n=r.x-e.x,o=r.y-e.y,d,a=0;s&&(d=r.x-s.x,a=r.y-s.y),L(t,"track",{state:e.state,x:i.clientX,y:i.clientY,dx:n,dy:o,ddx:d,ddy:a,sourceEvent:i,hover:function(){return Le(i.clientX,i.clientY)}})}q({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset:function(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown:function(e){m(e)&&(this.info.x=e.clientX,this.info.y=e.clientY)},click:function(e){m(e)&&U(this.info,e)},touchstart:function(e){const t=e.changedTouches[0];this.info.x=t.clientX,this.info.y=t.clientY},touchend:function(e){U(this.info,e.changedTouches[0],e)}});function U(e,t,i){let s=Math.abs(t.clientX-e.x),r=Math.abs(t.clientY-e.y),n=u(i||t);!n||Te[n.localName]&&n.hasAttribute("disabled")||(isNaN(s)||isNaN(r)||s<=Y&&r<=Y||Ae(t))&&(e.prevent||L(n,"tap",{x:t.clientX,y:t.clientY,sourceEvent:t,preventer:i}))}const He=k`:host {
...
blockquote-base-embedded-webview-resize {
  overflow-x: hidden;
}`,Xe=le`<svg aria-hidden="true" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
<polyline points="6 9 12 15 18 9" />
</svg>`;class W extends x{static get is(){return"blockquote-base-embedded-webview"}static get styles(){return[Ue]}static get properties(){return{heading:{type:String},selected:{type:Number},headingLevel:{type:Number,attribute:"heading-level",reflect:!0},screenSizeSelected:{type:Number,attribute:"screen-size-selected"},limitHeight:{type:Boolean,attribute:"limit-height",reflect:!0}}}constructor(){super(),this.selected=0,this.screenSizeSelected=0,this.headingLevel=1,this.heading="",this.__selectArrow=Xe,this.__readDataPos={x:0,y:0,resizing:!1},this.limitHeight=!1,this._sources=[{file:"",option:""}],this._updateSize=this._updateSize.bind(this),this._embeddedResizeRef=fe()}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this.shadowRoot.addEventListener("webviewresize",({detail:i})=>{Object.assign(this.__readDataPos,i),this.requestUpdate()});const t=Array.from(this.querySelectorAll("template"));t.length&&(this._sources=t.map(i=>{const{src:s,option:r}=i.dataset;return{src:s,option:r}}),this._src=this._sources[this.selected].src)}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),this.embedded=this.shadowRoot.querySelector('[slot="embedded"]'),this.append(this.embedded)}_updateSize({detail:t}){this._embeddedResizeRef.value.style.setProperty("--blockquote-base-embedded-webview-resize-rect-width",`${t.width}px`),this._embeddedResizeRef.value.style.setProperty("--blockquote-base-embedded-webview-resize-rect-height",this.limitHeight?"100%":`${t.height}px`)}get _headingLevel(){return this.headingLevel>=1&&this.headingLevel<=6?this.headingLevel:2}render(){return l`
      <header>
    ...
    `}get _headerTpl(){return l`<div aria-level="${this._headingLevel}" role="heading">${this.heading}</div>`}get _selectTpl(){return l`
      <div class="select">
        <select @change="${this._onChangeFile}" aria-label="Cases">
          ${this._sources.map((t,i)=>l`
    ...
    `}get _screenSizeTpl(){return l` <blockquote-base-embedded-webview-size
      @click="${this._updateSize}"
      @selectedchange="${this._updateSize}"
      .selected="${this.screenSizeSelected}"
    ></blockquote-base-embedded-webview-size>`}get _embeddedSlotTpl(){return l` <blockquote-base-embedded-webview-element
      slot="embedded"
      .src="${this._src}"
