var te=Object.defineProperty,ie=Object.defineProperties;var se=Object.getOwnPropertyDescriptors;var D=Object.getOwnPropertySymbols;var re=Object.prototype.hasOwnProperty,oe=Object.prototype.propertyIsEnumerable;var N=(e,t,i)=>t in e?te(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i,M=(e,t)=>{for(var i in t||(t={}))re.call(t,i)&&N(e,i,t[i]);if(D)for(var i of D(t))oe.call(t,i)&&N(e,i,t[i]);return e},P=(e,t)=>ie(e,se(t));import{i as ne,c as de,t as ae,e as ce,d as B,b as k,s as x,y as a,w as le}from"./directive-helpers.d0d4c120.js";/**
 * @license
...
*/let ve=0,G=0,f=[],_e=0,C=!1,V=document.createTextNode("");new window.MutationObserver(ze).observe(V,{characterData:!0});function ze(){C=!1;const e=f.length;for(let t=0;t<e;t++){let i=f[t];if(i)try{i()}catch(s){setTimeout(()=>{throw s})}}f.splice(0,e),G+=e}const ye={run(e){return C||(C=!0,V.textContent=_e++),f.push(e),ve++},cancel(e){const t=e-G;if(t>=0){if(!f[t])throw new Error("invalid async handle: "+e);f[t]=null}}};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
