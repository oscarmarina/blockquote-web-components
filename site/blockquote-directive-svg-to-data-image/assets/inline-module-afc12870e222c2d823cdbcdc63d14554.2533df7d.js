var te=Object.defineProperty,ie=Object.defineProperties;var se=Object.getOwnPropertyDescriptors;var D=Object.getOwnPropertySymbols;var re=Object.prototype.hasOwnProperty,oe=Object.prototype.propertyIsEnumerable;var B=(e,t,i)=>t in e?te(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i,M=(e,t)=>{for(var i in t||(t={}))re.call(t,i)&&B(e,i,t[i]);if(D)for(var i of D(t))oe.call(t,i)&&B(e,i,t[i]);return e},N=(e,t)=>ie(e,se(t));import{i as ne,c as de,t as ae,e as ce,d as P,b as k,s as x,y as a,w as le}from"./directive-helpers.d0d4c120.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const w=(e,t)=>{var i,s;const r=e._$AN;if(r===void 0)return!1;for(const o of r)(s=(i=o)._$AO)===null||s===void 0||s.call(i,t,!1),w(o,t);return!0},_=e=>{let t,i;do{if((t=e._$AM)===void 0)break;i=t._$AN,i.delete(e),e=t}while((i==null?void 0:i.size)===0)},j=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(i===void 0)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),be(t)}};function he(e){this._$AN!==void 0?(_(this),this._$AM=e,j(this)):this._$AM=e}function ue(e,t=!1,i=0){const s=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(s))for(let o=i;o<s.length;o++)w(s[o],!1),_(s[o]);else s!=null&&(w(s,!1),_(s));else w(this,e)}const be=e=>{var t,i,s,r;e.type==ae.CHILD&&((t=(s=e)._$AP)!==null&&t!==void 0||(s._$AP=ue),(i=(r=e)._$AQ)!==null&&i!==void 0||(r._$AQ=he))};class me extends ne{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,i,s){super._$AT(t,i,s),j(this),this.isConnected=t._$AU}_$AO(t,i=!0){var s,r;t!==this.isConnected&&(this.isConnected=t,t?(s=this.reconnected)===null||s===void 0||s.call(this):(r=this.disconnected)===null||r===void 0||r.call(this)),i&&(w(this,t),_(this))}setValue(t){if(de(this._$Ct))this._$Ct._$AI(t,this);else{const i=[...this._$Ct._$AH];i[this._$Ci]=t,this._$Ct._$AI(i,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fe=()=>new pe;class pe{}const E=new WeakMap,ge=ce(class extends me{render(e){return P}update(e,[t]){var i;const s=t!==this.Y;return s&&this.Y!==void 0&&this.rt(void 0),(s||this.lt!==this.dt)&&(this.Y=t,this.ct=(i=e.options)===null||i===void 0?void 0:i.host,this.rt(this.dt=e.element)),P}rt(e){var t;if(typeof this.Y=="function"){const i=(t=this.ct)!==null&&t!==void 0?t:globalThis;let s=E.get(i);s===void 0&&(s=new WeakMap,E.set(i,s)),s.get(this.Y)!==void 0&&this.Y.call(this.ct,void 0),s.set(this.Y,e),e!==void 0&&this.Y.call(this.ct,e)}else this.Y.value=e}get lt(){var e,t,i;return typeof this.Y=="function"?(t=E.get((e=this.ct)!==null&&e!==void 0?e:globalThis))===null||t===void 0?void 0:t.get(this.Y):(i=this.Y)===null||i===void 0?void 0:i.value}disconnected(){this.lt===this.dt&&this.rt(void 0)}reconnected(){this.rt(this.dt)}}),we=k`:host {
...
}`;class O extends x{static get is(){return"blockquote-base-embedded-webview-size"}static get styles(){return[we]}static get properties(){return{screenSizes:{type:Array,attribute:"screen-sizes"},selected:{type:Number},widthInPercent:{type:Boolean,attribute:"width-in-percent"},showOverflowSize:{type:Boolean,attribute:"show-overflow-size"},disabledSelectedSizeText:{type:Boolean,attribute:"disabled-selected-size-text"}}}constructor(){super(),this.showOverflowSize=!1,this.selected=0,this.disabledSelectedSizeText=!1,this.screenSizes=[{width:360,height:640,id:"360x640"},{width:360,height:800,id:"360x800"},{width:414,height:896,id:"414x896"},{width:768,height:1024,id:"768x1024"},{width:810,height:1080,id:"810x1080"},{width:1280,height:800,id:"1280x800"},{width:1366,height:768,id:"1366x768"},{width:1536,height:864,id:"1536x864"},{width:1920,height:1080,id:"1920x1080"}],this.widthInPercent=!1,this._onResize=this._onResize.bind(this)}get selectedSize(){return this.screenSizes[this.selected-1]}get selectedDetail(){return N(M({},this.selectedSize),{index:this.selected})}get computedStyleWidth(){return parseInt(window.getComputedStyle(this).width,10)}connectedCallback(){super.connectedCallback&&super.connectedCallback(),window.addEventListener("resize",this._onResize)}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),window.removeEventListener("resize",this._onResize)}willUpdate(t){super.willUpdate&&super.willUpdate(t),t.has("screenSizes")&&this.screenSizes.sort((i,s)=>s.width-i.width),t.has("selected")&&(this.selected>this.screenSizes.length||this.selected===0)&&(this.selected=this.screenSizes.length)}updated(t){if(super.updated&&super.updated(t),t.has("selected")){const i=new CustomEvent("selectedchange",{bubbles:!0,detail:this.selectedDetail});this.dispatchEvent(i)}}render(){return a`
      <div class="rect">
        ${this._toolbarTpl}
        ${this._visualTextTpl}
        </div>
...
*/let ve=0,G=0,f=[],_e=0,S=!1,V=document.createTextNode("");new window.MutationObserver(ze).observe(V,{characterData:!0});function ze(){S=!1;const e=f.length;for(let t=0;t<e;t++){let i=f[t];if(i)try{i()}catch(s){setTimeout(()=>{throw s})}}f.splice(0,e),G+=e}const ye={run(e){return S||(S=!0,V.textContent=_e++),f.push(e),ve++},cancel(e){const t=e-G;if(t>=0){if(!f[t])throw new Error("invalid async handle: "+e);f[t]=null}}};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
*::after {
  box-sizing: inherit;
}`;class X extends x{static get is(){return"blockquote-base-embedded-webview-element"}static get styles(){return[Ie]}static get properties(){return{embeddedTitle:{type:String,attribute:"embedded-title"},src:{type:String},type:{type:String}}}constructor(){super(),this.embeddedTitle="",this.src="",this.type="iframe",this._onLoadElement=this._onLoadElement.bind(this)}connectedCallback(){this._embeddedElement||(super.connectedCallback&&super.connectedCallback(),this._embeddedElement=document.createElement(this.type),Object.assign(this._embeddedElement,{slot:"embedded"}),this._embeddedElement.addEventListener("load",this._onLoadElement),this.append(this._embeddedElement))}willUpdate(t){super.willUpdate&&super.willUpdate(t),t.has("src")&&this.src!==""&&this._fetch(this.src)}render(){return a` ${this._embeddedTpl} `}get _loadResource(){return this.type==="iframe"?"src":"data"}get _embeddedTpl(){return a`<slot name="embedded"></slot>`}_fetch(t){t&&(Object.assign(this._embeddedElement,this.type==="iframe"&&{allow:"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture",allowFullscreen:!0,loading:"lazy"},this.embeddedTitle&&{title:this.embeddedTitle}),this._embeddedElement[this._loadResource]=t,window.performance.mark("iframestart"),Object.assign(this._embeddedElement.style,t.indexOf("http")!==0&&{opacity:0}))}_onLoadElement({target:t}){if(!t.contentDocument||!t.contentDocument.head.childNodes.length)return;Object.assign(t.contentDocument.body.dataset,{embedded:""}),window.performance.mark("iframeend"),window.performance.measure("iframe","iframestart","iframeend"),window.requestAnimationFrame(()=>t.removeAttribute("style"));const i=new CustomEvent("elementloaded",{bubbles:!0,detail:t});this.dispatchEvent(i)}}window.customElements.define(X.is,X);const Ue=k`:host {
