 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const gs={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ms=s=>(...e)=>({_$litDirective$:s,values:e});class bs{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;class Ms extends S{constructor(){super();w(this,"_updateSize",({detail:t})=>{var i,n,r,o;(n=(i=this._embeddedResizeRef)==null?void 0:i.value)==null||n.style.setProperty("--blockquote-base-embedded-webview-resize-rect-width",`${t.width}px`),(o=(r=this._embeddedResizeRef)==null?void 0:r.value)==null||o.style.setProperty("--blockquote-base-embedded-webview-resize-rect-height",this.limitHeight?"100%":`${t.height}px`),this.__resetResizing=!1,this.requestUpdate()});this.selected=0,this.screenSizeSelected=0,this.headingLevel=1,this.heading="",this.__resetResizing=!1,this.__selectArrow=Is,this.__readDataPos={x:"0",y:"0",resizing:!1,cursor:""},this.limitHeight=!1,this._sources=[{src:"",option:"",description:""}],this._embeddedResizeRef=$s()}static get styles(){return[Rs]}static get properties(){return{heading:{type:String},selected:{type:Number},headingLevel:{type:Number,attribute:"heading-level",reflect:!0},screenSizeSelected:{type:Number,attribute:"screen-size-selected"},limitHeight:{type:Boolean,attribute:"limit-height",reflect:!0}}}async connectedCallback(){var i,n;(i=super.connectedCallback)==null||i.call(this),await this.updateComplete,this.addEventListener("webviewresize",r=>{var c;const{detail:o}=r;Object.assign(this.__readDataPos,o),this.__resetResizing=!0,(o.cursor==="n"||o.cursor==="ne"||o.cursor==="nw")&&window.scroll({top:Math.abs(parseInt(this.__readDataPos.y,10)+((c=this._controlBottom)!=null?c:0)),left:0,behavior:"smooth"}),this.requestUpdate()});const t=Array.from(this.querySelectorAll("template"));t.length&&(this._sources=t.map(r=>{const{src:o="",option:c="",description:a=""}=r.dataset;return{src:o,option:c,description:a}}),this._src=this._sources[this.selected].src),this.embedded=(n=this.shadowRoot)==null?void 0:n.querySelector('[slot="embedded"]'),this._embeddedResizeRef.value&&(this._controlBottom=parseFloat(window.getComputedStyle(this._embeddedResizeRef.value).paddingBottom))}get _headingLevel(){return this.headingLevel>=1&&this.headingLevel<=6?this.headingLevel:2}render(){return b`
    ...
    `}_onChangeFile({target:t}){this.selected=t.selectedIndex,this._src=this._sources[this.selected].src}}window.customElements.define("blockquote-base-embedded-webview",Ms);function Ps(){if(typeof globalThis<"u")return globalThis;if(typeof self<"u")return self;if(typeof window<"u")return window;if(typeof global<"u")return global}function qs(){const s=Ps();if(s.__xstate__)return s.__xstate__}const Ds=s=>{if(typeof window>"u")return;const e=qs();e&&e.register(s)};class nt{constructor(e){this._process=e,this._active=!1,this._current=null,this._last=null}start(){this._active=!0,this.flush()}clear(){this._current&&(this._current.next=null,this._last=this._current)}enqueue(e){const t={value:e,next:null};if(this._current){this._last.next=t,this._last=t;return}this._current=t,this._last=t,this._active&&this.flush()}flush(){for(;this._current;){const e=this._current;this._process(e.value),this._current=e.next}this._last=null}}const At=".",Ls="",kt="",Us="#",Bs="*",Tt="xstate.init",xe="xstate.stop";function Hs(s,e){return{type:`xstate.after.${s}.${e}`}}function ze(s,e){return{type:`xstate.done.state.${s}`,output:e}}function js(s,e){return{type:`xstate.done.actor.${s}`,output:e,actorId:s}}function Ns(s,e){return{type:`xstate.error.actor.${s}`,error:e,actorId:s}}function Ct(s){return{type:Tt,input:s}}function $(s){setTimeout(()=>{throw s})}const Ws=typeof Symbol=="function"&&Symbol.observable||"@@observable";function Rt(s,e){const t=rt(s),i=rt(e);return typeof i=="string"?typeof t=="string"?i===t:!1:typeof t=="string"?t in i:Object.keys(t).every(n=>n in i?Rt(t[n],i[n]):!1)}function qe(s){if(Ot(s))return s;const e=[];let t="";for(let i=0;i<s.length;i++){switch(s.charCodeAt(i)){case 92:t+=s[i+1],i++;continue;case 46:e.push(t),t="";continue}t+=s[i]}return e.push(t),e}function rt(s){if(xi(s))return s.value;if(typeof s!="string")return s;const e=qe(s);return Ys(e)}function Ys(s){if(s.length===1)return s[0];const e={};let t=e;for(let i=0;i<s.length-1;i++)if(i===s.length-2)t[s[i]]=s[i+1];else{const n=t;t={},n[s[i]]=t}return e}function ot(s,e){const t={},i=Object.keys(s);for(let n=0;n<i.length;n++){const r=i[n];t[r]=e(s[r],r,s,n)}return t}function It(s){return Ot(s)?s:[s]}function E(s){return s===void 0?[]:It(s)}function Ee(s,e,t,i){return typeof s=="function"?s({context:e,event:t,self:i}):s}function Ot(s){return Array.isArray(s)}function Js(s){return s.type.startsWith("xstate.error.actor")}function L(s){return It(s).map(e=>typeof e>"u"||typeof e=="string"?{target:e}:e)}function Mt(s){if(!(s===void 0||s===Ls))return E(s)}function Ae(s,e,t){var r,o,c;const i=typeof s=="object",n=i?s:void 0;return{next:(r=i?s.next:s)==null?void 0:r.bind(n),error:(o=i?s.error:e)==null?void 0:o.bind(n),complete:(c=i?s.complete:t)==null?void 0:c.bind(n)}}function ct(s,e){return`${e}.${s}`}function De(s,e){const t=e.match(/^xstate\.invoke\.(\d+)\.(.*)/);if(!t)return s.implementations.actors[e];const[,i,n]=t,o=s.getStateNodeById(n).config.invoke;return(Array.isArray(o)?o[i]:o).src}function at(s,e){return`${s.sessionId}.${e}`}let Vs=0;function Gs(s,e){var g;const t=new Map,i=new Map,n=new WeakMap,r=new Set,o={},{clock:c,logger:a}=e,h={schedule:(u,f,p,m,y=Math.random().toString(36).slice(2))=>{const Y={source:u,target:f,event:p,delay:m,id:y,startedAt:Date.now()},x=at(u,y);d._snapshot._scheduledEvents[x]=Y;const Jt=c.setTimeout(()=>{delete o[x],delete d._snapshot._scheduledEvents[x],d._relay(u,f,p)},m);o[x]=Jt},cancel:(u,f)=>{const p=at(u,f),m=o[p];delete o[p],delete d._snapshot._scheduledEvents[p],m!==void 0&&c.clearTimeout(m)},cancelAll:u=>{for(const f in d._snapshot._scheduledEvents){const p=d._snapshot._scheduledEvents[f];p.source===u&&h.cancel(u,p.id)}}},l=u=>{if(!r.size)return;const f={...u,rootId:s.sessionId};r.forEach(p=>{var m;return(m=p.next)==null?void 0:m.call(p,f)})},d={_snapshot:{_scheduledEvents:(g=(e==null?void 0:e.snapshot)&&e.snapshot.scheduler)!=null?g:{}},_bookId:()=>`x:${Vs++}`,_register:(u,f)=>(t.set(u,f),u),_unregister:u=>{t.delete(u.sessionId);const f=n.get(u);f!==void 0&&(i.delete(f),n.delete(u))},get:u=>i.get(u),_set:(u,f)=>{const p=i.get(u);if(p&&p!==f)throw new Error(`Actor with system ID '${u}' already exists.`);i.set(u,f),n.set(f,u)},inspect:u=>{const f=Ae(u);return r.add(f),{unsubscribe(){r.delete(f)}}},_sendInspectionEvent:l,_relay:(u,f,p)=>{d._sendInspectionEvent({type:"@xstate.event",sourceRef:u,actorRef:f,event:p}),f._send(p)},scheduler:h,getSnapshot:()=>({_scheduledEvents:{...d._snapshot._scheduledEvents}}),start:()=>{const u=d._snapshot._scheduledEvents;d._snapshot._scheduledEvents={};for(const f in u){const{source:p,target:m,event:y,delay:Y,id:x}=u[f];h.schedule(p,m,y,Y,x)}},_clock:c,_logger:a};return d}let ye=!1;const Le=1;let v=function(s){return s[s.NotStarted=0]="NotStarted",s[s.Running=1]="Running",s[s.Stopped=2]="Stopped",s}({});const Xs={clock:{setTimeout:(s,e)=>setTimeout(s,e),clearTimeout:s=>clearTimeout(s)},logger:console.log.bind(console),devTools:!1};class Zs{constructor(e,t){var d,g,u,f;this.logic=e,this._snapshot=void 0,this.clock=void 0,this.options=void 0,this.id=void 0,this.mailbox=new nt(this._process.bind(this)),this.observers=new Set,this.eventListeners=new Map,this.logger=void 0,this._processingStatus=v.NotStarted,this._parent=void 0,this._syncSnapshot=void 0,this.ref=void 0,this._actorScope=void 0,this._systemId=void 0,this.sessionId=void 0,this.system=void 0,this._doneEvent=void 0,this.src=void 0,this._deferred=[];const i={...Xs,...t},{clock:n,logger:r,parent:o,syncSnapshot:c,id:a,systemId:h,inspect:l}=i;this.system=o?o.system:Gs(this,{clock:n,logger:r}),l&&!o&&this.system.inspect(Ae(l)),this.sessionId=this.system._bookId(),this.id=a!=null?a:this.sessionId,this.logger=(d=t==null?void 0:t.logger)!=null?d:this.system._logger,this.clock=(g=t==null?void 0:t.clock)!=null?g:this.system._clock,this._parent=o,this._syncSnapshot=c,this.options=i,this.src=(u=i.src)!=null?u:e,this.ref=this,this._actorScope={self:this,id:this.id,sessionId:this.sessionId,logger:this.logger,defer:p=>{this._deferred.push(p)},system:this.system,stopChild:p=>{if(p._parent!==this)throw new Error(`Cannot stop child actor ${p.id} of ${this.id} because it is not a child`);p._stop()},emit:p=>{const m=this.eventListeners.get(p.type),y=this.eventListeners.get("*");if(!m&&!y)return;const Y=[...m?m.values():[],...y?y.values():[]];for(const x of Y)x(p)},actionExecutor:p=>{const m=()=>{if(this._actorScope.system._sendInspectionEvent({type:"@xstate.action",actorRef:this,action:{type:p.type,params:p.params}}),!p.exec)return;const y=ye;try{ye=!0,p.exec(p.info,p.params)}finally{ye=y}};this._processingStatus===v.Running?m():this._deferred.push(m)}},this.send=this.send.bind(this),this.system._sendInspectionEvent({type:"@xstate.actor",actorRef:this}),h&&(this._systemId=h,this.system._set(h,this)),this._initState((f=t==null?void 0:t.snapshot)!=null?f:t==null?void 0:t.state),h&&this._snapshot.status!=="active"&&this.system._unregister(this)}_initState(e){var t;try{this._snapshot=e?this.logic.restoreSnapshot?this.logic.restoreSnapshot(e,this._actorScope):e:this.logic.getInitialSnapshot(this._actorScope,(t=this.options)==null?void 0:t.input)}catch(i){this._snapshot={status:"error",output:void 0,error:i}}}update(e,t){var n,r;this._snapshot=e;let i;for(;i=this._deferred.shift();)try{i()}catch(o){this._deferred.length=0,this._snapshot={...e,status:"error",error:o}}switch(this._snapshot.status){case"active":for(const o of this.observers)try{(n=o.next)==null||n.call(o,e)}catch(c){$(c)}break;case"done":for(const o of this.observers)try{(r=o.next)==null||r.call(o,e)}catch(c){$(c)}this._stopProcedure(),this._complete(),this._doneEvent=js(this.id,this._snapshot.output),this._parent&&this.system._relay(this,this._parent,this._doneEvent);break;case"error":this._error(this._snapshot.error);break}this.system._sendInspectionEvent({type:"@xstate.snapshot",actorRef:this,event:t,snapshot:e})}subscribe(e,t,i){var r;const n=Ae(e,t,i);if(this._processingStatus!==v.Stopped)this.observers.add(n);else switch(this._snapshot.status){case"done":try{(r=n.complete)==null||r.call(n)}catch(o){$(o)}break;case"error":{const o=this._snapshot.error;if(!n.error)$(o);else try{n.error(o)}catch(c){$(c)}break}}return{unsubscribe:()=>{this.observers.delete(n)}}}on(e,t){let i=this.eventListeners.get(e);i||(i=new Set,this.eventListeners.set(e,i));const n=t.bind(void 0);return i.add(n),{unsubscribe:()=>{i.delete(n)}}}start(){if(this._processingStatus===v.Running)return this;this._syncSnapshot&&this.subscribe({next:i=>{i.status==="active"&&this.system._relay(this,this._parent,{type:`xstate.snapshot.${this.id}`,snapshot:i})},error:()=>{}}),this.system._register(this.sessionId,this),this._systemId&&this.system._set(this._systemId,this),this._processingStatus=v.Running;const e=Ct(this.options.input);switch(this.system._sendInspectionEvent({type:"@xstate.event",sourceRef:this._parent,actorRef:this,event:e}),this._snapshot.status){case"done":return this.update(this._snapshot,e),this;case"error":return this._error(this._snapshot.error),this}if(this._parent||this.system.start(),this.logic.start)try{this.logic.start(this._snapshot,this._actorScope)}catch(i){return this._snapshot={...this._snapshot,status:"error",error:i},this._error(i),this}return this.update(this._snapshot,e),this.options.devTools&&this.attachDevTools(),this.mailbox.start(),this}_process(e){let t,i;try{t=this.logic.transition(this._snapshot,e,this._actorScope)}catch(n){i={err:n}}if(i){const{err:n}=i;this._snapshot={...this._snapshot,status:"error",error:n},this._error(n);return}this.update(t,e),e.type===xe&&(this._stopProcedure(),this._complete())}_stop(){return this._processingStatus===v.Stopped?this:(this.mailbox.clear(),this._processingStatus===v.NotStarted?(this._processingStatus=v.Stopped,this):(this.mailbox.enqueue({type:xe}),this))}stop(){if(this._parent)throw new Error("A non-root actor cannot be stopped directly.");return this._stop()}_complete(){var e;for(const t of this.observers)try{(e=t.complete)==null||e.call(t)}catch(i){$(i)}this.observers.clear()}_reportError(e){if(!this.observers.size){this._parent||$(e);return}let t=!1;for(const i of this.observers){const n=i.error;t||(t=!n);try{n==null||n(e)}catch(r){$(r)}}this.observers.clear(),t&&$(e)}_error(e){this._stopProcedure(),this._reportError(e),this._parent&&this.system._relay(this,this._parent,Ns(this.id,e))}_stopProcedure(){return this._processingStatus!==v.Running?this:(this.system.scheduler.cancelAll(this),this.mailbox.clear(),this.mailbox=new nt(this._process.bind(this)),this._processingStatus=v.Stopped,this.system._unregister(this),this)}_send(e){this._processingStatus!==v.Stopped&&this.mailbox.enqueue(e)}send(e){this.system._relay(void 0,this,e)}attachDevTools(){const{devTools:e}=this.options;e&&(typeof e=="function"?e:Ds)(this)}toJSON(){return{xstate$$type:Le,id:this.id}}getPersistedSnapshot(e){return this.logic.getPersistedSnapshot(this._snapshot,e)}[Ws](){return this}getSnapshot(){return this._snapshot}}function se(s,...[e]){return new Zs(s,e)}function Fs(s,e,t,i,{sendId:n}){const r=typeof n=="function"?n(t,i):n;return[e,{sendId:r},void 0]}function Ks(s,e){s.defer(()=>{s.system.scheduler.cancel(s.self,e.sendId)})}function Qs(s){function e(t,i){}return e.type="xstate.cancel",e.sendId=s,e.resolve=Fs,e.execute=Ks,e}function ei(s,e,t,i,{id:n,systemId:r,src:o,input:c,syncSnapshot:a}){const h=typeof o=="string"?De(e.machine,o):o,l=typeof n=="function"?n(t):n;let d,g;return h&&(g=typeof c=="function"?c({context:e.context,event:t.event,self:s.self}):c,d=se(h,{id:l,src:o,parent:s.self,syncSnapshot:a,systemId:r,input:g})),[P(e,{children:{...e.children,[l]:d}}),{id:n,systemId:r,actorRef:d,src:o,input:g},void 0]}function ti(s,{actorRef:e}){e&&s.defer(()=>{e._processingStatus!==v.Stopped&&e.start()})}function si(...[s,{id:e,systemId:t,input:i,syncSnapshot:n=!1}={}]){function r(o,c){}return r.type="xstate.spawnChild",r.id=e,r.systemId=t,r.src=s,r.input=i,r.syncSnapshot=n,r.resolve=ei,r.execute=ti,r}function ii(s,e,t,i,{actorRef:n}){const r=typeof n=="function"?n(t,i):n,o=typeof r=="string"?e.children[r]:r;let c=e.children;return o&&(c={...c},delete c[o.id]),[P(e,{children:c}),o,void 0]}function ni(s,e){if(e){if(s.system._unregister(e),e._processingStatus!==v.Running){s.stopChild(e);return}s.defer(()=>{s.stopChild(e)})}}function Pt(s){function e(t,i){}return e.type="xstate.stopChild",e.actorRef=s,e.resolve=ii,e.execute=ni,e}function Ue(s,e,t,i){const{machine:n}=i,r=typeof s=="function",o=r?s:n.implementations.guards[typeof s=="string"?s:s.type];if(!r&&!o)throw new Error(`Guard '${typeof s=="string"?s:s.type}' is not implemented.'.`);if(typeof o!="function")return Ue(o,e,t,i);const c={context:e,event:t},a=r||typeof s=="string"?void 0:"params"in s?typeof s.params=="function"?s.params({context:e,event:t}):s.params:void 0;return"check"in o?o.check(i,c,o):o(c,a)}const Be=s=>s.type==="atomic"||s.type==="final";function j(s){return Object.values(s.states).filter(e=>e.type!=="history")}function re(s,e){const t=[];if(e===s)return t;let i=s.parent;for(;i&&i!==e;)t.push(i),i=i.parent;return t}function de(s){const e=new Set(s),t=Dt(e);for(const i of e)if(i.type==="compound"&&(!t.get(i)||!t.get(i).length))ht(i).forEach(n=>e.add(n));else if(i.type==="parallel"){for(const n of j(i))if(n.type!=="history"&&!e.has(n)){const r=ht(n);for(const o of r)e.add(o)}}for(const i of e){let n=i.parent;for(;n;)e.add(n),n=n.parent}return e}function qt(s,e){const t=e.get(s);if(!t)return{};if(s.type==="compound"){const n=t[0];if(n){if(Be(n))return n.key}else return{}}const i={};for(const n of t)i[n.key]=qt(n,e);return i}function Dt(s){const e=new Map;for(const t of s)e.has(t)||e.set(t,[]),t.parent&&(e.has(t.parent)||e.set(t.parent,[]),e.get(t.parent).push(t));return e}function Lt(s,e){const t=de(e);return qt(s,Dt(t))}function He(s,e){return e.type==="compound"?j(e).some(t=>t.type==="final"&&s.has(t)):e.type==="parallel"?j(e).every(t=>He(s,t)):e.type==="final"}const pe=s=>s[0]===Us;function ri(s,e){return s.transitions.get(e)||[...s.transitions.keys()].filter(i=>{if(i===Bs)return!0;if(!i.endsWith(".*"))return!1;const n=i.split("."),r=e.split(".");for(let o=0;o<n.length;o++){const c=n[o],a=r[o];if(c==="*")return o===n.length-1;if(c!==a)return!1}return!0}).sort((i,n)=>n.length-i.length).flatMap(i=>s.transitions.get(i))}function oi(s){const e=s.config.after;if(!e)return[];const t=n=>{const r=Hs(n,s.id),o=r.type;return s.entry.push(Oi(r,{id:o,delay:n})),s.exit.push(Qs(o)),o};return Object.keys(e).flatMap(n=>{const r=e[n],o=typeof r=="string"?{target:r}:r,c=Number.isNaN(+n)?n:+n,a=t(c);return E(o).map(h=>({...h,event:a,delay:c}))}).map(n=>{const{delay:r}=n;return{...C(s,n.event,n),delay:r}})}function C(s,e,t){var c;const i=Mt(t.target),n=(c=t.reenter)!=null?c:!1,r=hi(s,i),o={...t,actions:E(t.actions),guard:t.guard,target:r,source:s,reenter:n,eventType:e,toJSON:()=>({...o,source:`#${s.id}`,target:r?r.map(a=>`#${a.id}`):void 0})};return o}function ci(s){const e=new Map;if(s.config.on)for(const t of Object.keys(s.config.on)){if(t===kt)throw new Error('Null events ("") cannot be specified as a transition key. Use `always: { ... }` instead.');const i=s.config.on[t];e.set(t,L(i).map(n=>C(s,t,n)))}if(s.config.onDone){const t=`xstate.done.state.${s.id}`;e.set(t,L(s.config.onDone).map(i=>C(s,t,i)))}for(const t of s.invoke){if(t.onDone){const i=`xstate.done.actor.${t.id}`;e.set(i,L(t.onDone).map(n=>C(s,i,n)))}if(t.onError){const i=`xstate.error.actor.${t.id}`;e.set(i,L(t.onError).map(n=>C(s,i,n)))}if(t.onSnapshot){const i=`xstate.snapshot.${t.id}`;e.set(i,L(t.onSnapshot).map(n=>C(s,i,n)))}}for(const t of s.after){let i=e.get(t.eventType);i||(i=[],e.set(t.eventType,i)),i.push(t)}return e}function ai(s,e){const t=typeof e=="string"?s.states[e]:e?s.states[e.target]:void 0;if(!t&&e)throw new Error(`Initial state node "${e}" not found on parent state node #${s.id}`);const i={source:s,actions:!e||typeof e=="string"?[]:E(e.actions),eventType:null,reenter:!1,target:t?[t]:[],toJSON:()=>({...i,source:`#${s.id}`,target:t?[`#${t.id}`]:[]})};return i}function hi(s,e){if(e!==void 0)return e.map(t=>{if(typeof t!="string")return t;if(pe(t))return s.machine.getStateNodeById(t);const i=t[0]===At;if(i&&!s.parent)return le(s,t.slice(1));const n=i?s.key+t:t;if(s.parent)try{return le(s.parent,n)}catch(r){throw new Error(`Invalid transition definition for state node '${s.id}':
${r.message}`)}else throw new Error(`Invalid target: "${t}" is not a valid target from the root node. Did you mean ".${t}"?`)})}function Ut(s){const e=Mt(s.config.target);return e?{target:e.map(t=>typeof t=="string"?le(s.parent,t):t)}:s.parent.initial}function I(s){return s.type==="history"}function ht(s){const e=Bt(s);for(const t of e)for(const i of re(t,s))e.add(i);return e}function Bt(s){const e=new Set;function t(i){if(!e.has(i)){if(e.add(i),i.type==="compound")t(i.initial.target[0]);else if(i.type==="parallel")for(const n of j(i))t(n)}}return t(s),e}function N(s,e){if(pe(e))return s.machine.getStateNodeById(e);if(!s.states)throw new Error(`Unable to retrieve child state '${e}' from '${s.id}'; no child states exist.`);const t=s.states[e];if(!t)throw new Error(`Child state '${e}' does not exist on '${s.id}'`);return t}function le(s,e){if(typeof e=="string"&&pe(e))try{return s.machine.getStateNodeById(e)}catch{}const t=qe(e).slice();let i=s;for(;t.length;){const n=t.shift();if(!n.length)break;i=N(i,n)}return i}function ue(s,e){if(typeof e=="string"){const n=s.states[e];if(!n)throw new Error(`State '${e}' does not exist on '${s.id}'`);return[s,n]}const t=Object.keys(e),i=t.map(n=>N(s,n)).filter(Boolean);return[s.machine.root,s].concat(i,t.reduce((n,r)=>{const o=N(s,r);if(!o)return n;const c=ue(o,e[r]);return n.concat(c)},[]))}function di(s,e,t,i){const r=N(s,e).next(t,i);return!r||!r.length?s.next(t,i):r}function li(s,e,t,i){const n=Object.keys(e),r=N(s,n[0]),o=je(r,e[n[0]],t,i);return!o||!o.length?s.next(t,i):o}function ui(s,e,t,i){const n=[];for(const r of Object.keys(e)){const o=e[r];if(!o)continue;const c=N(s,r),a=je(c,o,t,i);a&&n.push(...a)}return n.length?n:s.next(t,i)}function je(s,e,t,i){return typeof e=="string"?di(s,e,t,i):Object.keys(e).length===1?li(s,e,t,i):ui(s,e,t,i)}function fi(s){return Object.keys(s.states).map(e=>s.states[e]).filter(e=>e.type==="history")}function k(s,e){let t=s;for(;t.parent&&t.parent!==e;)t=t.parent;return t.parent===e}function pi(s,e){const t=new Set(s),i=new Set(e);for(const n of t)if(i.has(n))return!0;for(const n of i)if(t.has(n))return!0;return!1}function Ht(s,e,t){const i=new Set;for(const n of s){let r=!1;const o=new Set;for(const c of i)if(pi(ke([n],e,t),ke([c],e,t)))if(k(n.source,c.source))o.add(c);else{r=!0;break}if(!r){for(const c of o)i.delete(c);i.add(n)}}return Array.from(i)}function gi(s){const[e,...t]=s;for(const i of re(e,void 0))if(t.every(n=>k(n,i)))return i}function Ne(s,e){if(!s.target)return[];const t=new Set;for(const i of s.target)if(I(i))if(e[i.id])for(const n of e[i.id])t.add(n);else for(const n of Ne(Ut(i),e))t.add(n);else t.add(i);return[...t]}function jt(s,e){const t=Ne(s,e);if(!t)return;if(!s.reenter&&t.every(n=>n===s.source||k(n,s.source)))return s.source;const i=gi(t.concat(s.source));if(i)return i;if(!s.reenter)return s.source.machine.root}function ke(s,e,t){var n;const i=new Set;for(const r of s)if((n=r.target)!=null&&n.length){const o=jt(r,t);r.reenter&&r.source===o&&i.add(o);for(const c of e)k(c,o)&&i.add(c)}return[...i]}function mi(s,e){if(s.length!==e.size)return!1;for(const t of s)if(!e.has(t))return!1;return!0}function Te(s,e,t,i,n,r){if(!s.length)return e;const o=new Set(e._nodes);let c=e.historyValue;const a=Ht(s,o,c);let h=e;n||([h,c]=yi(h,i,t,a,o,c,r,t.actionExecutor)),h=W(h,i,t,a.flatMap(d=>d.actions),r,void 0),h=_i(h,i,t,a,o,r,c,n);const l=[...o];h.status==="done"&&(h=W(h,i,t,l.sort((d,g)=>g.order-d.order).flatMap(d=>d.exit),r,void 0));try{return c===e.historyValue&&mi(e._nodes,o)?h:P(h,{_nodes:l,historyValue:c})}catch(d){throw d}}function bi(s,e,t,i,n){if(i.output===void 0)return;const r=ze(n.id,n.output!==void 0&&n.parent?Ee(n.output,s.context,e,t.self):void 0);return Ee(i.output,s.context,r,t.self)}function _i(s,e,t,i,n,r,o,c){let a=s;const h=new Set,l=new Set;vi(i,o,l,h),c&&l.add(s.machine.root);const d=new Set;for(const g of[...h].sort((u,f)=>u.order-f.order)){n.add(g);const u=[];u.push(...g.entry);for(const f of g.invoke)u.push(si(f.src,{...f,syncSnapshot:!!f.onSnapshot}));if(l.has(g)){const f=g.initial.actions;u.push(...f)}if(a=W(a,e,t,u,r,g.invoke.map(f=>f.id)),g.type==="final"){const f=g.parent;let p=(f==null?void 0:f.type)==="parallel"?f:f==null?void 0:f.parent,m=p||g;for((f==null?void 0:f.type)==="compound"&&r.push(ze(f.id,g.output!==void 0?Ee(g.output,a.context,e,t.self):void 0));(p==null?void 0:p.type)==="parallel"&&!d.has(p)&&He(n,p);)d.add(p),r.push(ze(p.id)),m=p,p=p.parent;if(p)continue;a=P(a,{status:"done",output:bi(a,e,t,a.machine.root,m)})}}return a}function vi(s,e,t,i){for(const n of s){const r=jt(n,e);for(const c of n.target||[])!I(c)&&(n.source!==c||n.source!==r||n.reenter)&&(i.add(c),t.add(c)),U(c,e,t,i);const o=Ne(n,e);for(const c of o){const a=re(c,r);(r==null?void 0:r.type)==="parallel"&&a.push(r),Nt(i,e,t,a,!n.source.parent&&n.reenter?void 0:r)}}}function U(s,e,t,i){var n;if(I(s))if(e[s.id]){const r=e[s.id];for(const o of r)i.add(o),U(o,e,t,i);for(const o of r)we(o,s.parent,i,e,t)}else{const r=Ut(s);for(const o of r.target)i.add(o),r===((n=s.parent)==null?void 0:n.initial)&&t.add(s.parent),U(o,e,t,i);for(const o of r.target)we(o,s.parent,i,e,t)}else if(s.type==="compound"){const[r]=s.initial.target;I(r)||(i.add(r),t.add(r)),U(r,e,t,i),we(r,s,i,e,t)}else if(s.type==="parallel")for(const r of j(s).filter(o=>!I(o)))[...i].some(o=>k(o,r))||(I(r)||(i.add(r),t.add(r)),U(r,e,t,i))}function Nt(s,e,t,i,n){for(const r of i)if((!n||k(r,n))&&s.add(r),r.type==="parallel")for(const o of j(r).filter(c=>!I(c)))[...s].some(c=>k(c,o))||(s.add(o),U(o,e,t,s))}function we(s,e,t,i,n){Nt(t,i,n,re(s,e))}function yi(s,e,t,i,n,r,o,c){let a=s;const h=ke(i,n,r);h.sort((d,g)=>g.order-d.order);let l;for(const d of h)for(const g of fi(d)){let u;g.history==="deep"?u=f=>Be(f)&&k(f,d):u=f=>f.parent===d,l!=null||(l={...r}),l[g.id]=Array.from(n).filter(u)}for(const d of h)a=W(a,e,t,[...d.exit,...d.invoke.map(g=>Pt(g.id))],o,void 0),n.delete(d);return[a,l||r]}function wi(s,e){return s.implementations.actions[e]}function Wt(s,e,t,i,n,r){const{machine:o}=s;let c=s;for(const a of i){const h=typeof a=="function",l=h?a:wi(o,typeof a=="string"?a:a.type),d={context:c.context,event:e,self:t.self,system:t.system},g=h||typeof a=="string"?void 0:"params"in a?typeof a.params=="function"?a.params({context:c.context,event:e}):a.params:void 0;if(!l||!("resolve"in l)){t.actionExecutor({type:typeof a=="string"?a:typeof a=="object"?a.type:a.name||"(anonymous)",info:d,params:g,exec:l});continue}const u=l,[f,p,m]=u.resolve(t,c,d,g,l,n);c=f,"retryResolve"in u&&(r==null||r.push([u,p])),"execute"in u&&t.actionExecutor({type:u.type,info:d,params:p,exec:u.execute.bind(null,t,p)}),m&&(c=Wt(c,e,t,m,n,r))}return c}function W(s,e,t,i,n,r){const o=r?[]:void 0,c=Wt(s,e,t,i,{internalQueue:n,deferredActorIds:r},o);return o==null||o.forEach(([a,h])=>{a.retryResolve(t,c,h)}),c}function $e(s,e,t,i){let n=s;const r=[];function o(h,l,d){t.system._sendInspectionEvent({type:"@xstate.microstep",actorRef:t.self,event:l,snapshot:h,_transitions:d}),r.push(h)}if(e.type===xe)return n=P(dt(n,e,t),{status:"stopped"}),o(n,e,[]),{snapshot:n,microstates:r};let c=e;if(c.type!==Tt){const h=c,l=Js(h),d=lt(h,n);if(l&&!d.length)return n=P(s,{status:"error",error:h.error}),o(n,h,[]),{snapshot:n,microstates:r};n=Te(d,s,t,c,!1,i),o(n,h,d)}let a=!0;for(;n.status==="active";){let h=a?$i(n,c):[];const l=h.length?n:void 0;if(!h.length){if(!i.length)break;c=i.shift(),h=lt(c,n)}n=Te(h,n,t,c,!1,i),a=n!==l,o(n,c,h)}return n.status!=="active"&&dt(n,c,t),{snapshot:n,microstates:r}}function dt(s,e,t){return W(s,e,t,Object.values(s.children).map(i=>Pt(i)),[],void 0)}function lt(s,e){return e.machine.getTransitionData(e,s)}function $i(s,e){const t=new Set,i=s._nodes.filter(Be);for(const n of i)e:for(const r of[n].concat(re(n,void 0)))if(r.always){for(const o of r.always)if(o.guard===void 0||Ue(o.guard,s.context,e,s)){t.add(o);break e}}return Ht(Array.from(t),new Set(s._nodes),s.historyValue)}function Si(s,e){const t=de(ue(s,e));return Lt(s,[...t])}function xi(s){return!!s&&typeof s=="object"&&"machine"in s&&"value"in s}const zi=function(e){return Rt(e,this.value)},Ei=function(e){return this.tags.has(e)},Ai=function(e){const t=this.machine.getTransitionData(this,e);return!!(t!=null&&t.length)&&t.some(i=>i.target!==void 0||i.actions.length)},ki=function(){const{_nodes:e,tags:t,machine:i,getMeta:n,toJSON:r,can:o,hasTag:c,matches:a,...h}=this;return{...h,tags:Array.from(t)}},Ti=function(){return this._nodes.reduce((e,t)=>(t.meta!==void 0&&(e[t.id]=t.meta),e),{})};function ce(s,e){return{status:s.status,output:s.output,error:s.error,machine:e,context:s.context,_nodes:s._nodes,value:Lt(e.root,s._nodes),tags:new Set(s._nodes.flatMap(t=>t.tags)),children:s.children,historyValue:s.historyValue||{},matches:zi,hasTag:Ei,can:Ai,getMeta:Ti,toJSON:ki}}function P(s,e={}){return ce({...s,...e},s.machine)}function Ci(s,e){const{_nodes:t,tags:i,machine:n,children:r,context:o,can:c,hasTag:a,matches:h,getMeta:l,toJSON:d,...g}=s,u={};for(const p in r){const m=r[p];u[p]={snapshot:m.getPersistedSnapshot(e),src:m.src,systemId:m._systemId,syncSnapshot:m._syncSnapshot}}return{...g,context:Yt(o),children:u}}function Yt(s){let e;for(const t in s){const i=s[t];if(i&&typeof i=="object")if("sessionId"in i&&"send"in i&&"ref"in i)e!=null||(e=Array.isArray(s)?s.slice():{...s}),e[t]={xstate$$type:Le,id:i.id};else{const n=Yt(i);n!==i&&(e!=null||(e=Array.isArray(s)?s.slice():{...s}),e[t]=n)}}return e!=null?e:s}function Ri(s,e,t,i,{event:n,id:r,delay:o},{internalQueue:c}){const a=e.machine.implementations.delays;if(typeof n=="string")throw new Error(`Only event objects may be used with raise; use raise({ type: "${n}" }) instead`);const h=typeof n=="function"?n(t,i):n;let l;if(typeof o=="string"){const d=a&&a[o];l=typeof d=="function"?d(t,i):d}else l=typeof o=="function"?o(t,i):o;return typeof l!="number"&&c.push(h),[e,{event:h,id:r,delay:l},void 0]}function Ii(s,e){const{event:t,delay:i,id:n}=e;if(typeof i=="number"){s.defer(()=>{const r=s.self;s.system.scheduler.schedule(r,r,t,i,n)});return}}function Oi(s,e){function t(i,n){}return t.type="xstate.raise",t.event=s,t.id=e==null?void 0:e.id,t.delay=e==null?void 0:e.delay,t.resolve=Ri,t.execute=Ii,t}function Mi(s,{machine:e,context:t},i,n){const r=(o,c)=>{if(typeof o=="string"){const a=De(e,o);if(!a)throw new Error(`Actor logic '${o}' not implemented in machine '${e.id}'`);const h=se(a,{id:c==null?void 0:c.id,parent:s.self,syncSnapshot:c==null?void 0:c.syncSnapshot,input:typeof(c==null?void 0:c.input)=="function"?c.input({context:t,event:i,self:s.self}):c==null?void 0:c.input,src:o,systemId:c==null?void 0:c.systemId});return n[h.id]=h,h}else return se(o,{id:c==null?void 0:c.id,parent:s.self,syncSnapshot:c==null?void 0:c.syncSnapshot,input:c==null?void 0:c.input,src:o,systemId:c==null?void 0:c.systemId})};return(o,c)=>{const a=r(o,c);return n[a.id]=a,s.defer(()=>{a._processingStatus!==v.Stopped&&a.start()}),a}}function Pi(s,e,t,i,{assignment:n}){if(!e.context)throw new Error("Cannot assign to undefined `context`. Ensure that `context` is defined in the machine config.");const r={},o={context:e.context,event:t.event,spawn:Mi(s,e,t.event,r),self:s.self,system:s.system};let c={};if(typeof n=="function")c=n(o,i);else for(const h of Object.keys(n)){const l=n[h];c[h]=typeof l=="function"?l(o,i):l}const a=Object.assign({},e.context,c);return[P(e,{context:a,children:Object.keys(r).length?{...e.children,...r}:e.children}),void 0,void 0]}function Ce(s){function e(t,i){}return e.type="xstate.assign",e.assignment=s,e.resolve=Pi,e}const ut=new WeakMap;function q(s,e,t){let i=ut.get(s);return i?e in i||(i[e]=t()):(i={[e]:t()},ut.set(s,i)),i[e]}const qi={},G=s=>typeof s=="string"?{type:s}:typeof s=="function"?"resolve"in s?{type:s.type}:{type:s.name}:s;class We{constructor(e,t){if(this.config=e,this.key=void 0,this.id=void 0,this.type=void 0,this.path=void 0,this.states=void 0,this.history=void 0,this.entry=void 0,this.exit=void 0,this.parent=void 0,this.machine=void 0,this.meta=void 0,this.output=void 0,this.order=-1,this.description=void 0,this.tags=[],this.transitions=void 0,this.always=void 0,this.parent=t._parent,this.key=t._key,this.machine=t._machine,this.path=this.parent?this.parent.path.concat(this.key):[],this.id=this.config.id||[this.machine.id,...this.path].join(At),this.type=this.config.type||(this.config.states&&Object.keys(this.config.states).length?"compound":this.config.history?"history":"atomic"),this.description=this.config.description,this.order=this.machine.idMap.size,this.machine.idMap.set(this.id,this),this.states=this.config.states?ot(this.config.states,(i,n)=>new We(i,{_parent:this,_key:n,_machine:this.machine})):qi,this.type==="compound"&&!this.config.initial)throw new Error(`No initial state specified for compound state node "#${this.id}". Try adding { initial: "${Object.keys(this.states)[0]}" } to the state config.`);this.history=this.config.history===!0?"shallow":this.config.history||!1,this.entry=E(this.config.entry).slice(),this.exit=E(this.config.exit).slice(),this.meta=this.config.meta,this.output=this.type==="final"||!this.parent?this.config.output:void 0,this.tags=E(e.tags).slice()}_initialize(){this.transitions=ci(this),this.config.always&&(this.always=L(this.config.always).map(e=>C(this,kt,e))),Object.keys(this.states).forEach(e=>{this.states[e]._initialize()})}get definition(){return{id:this.id,key:this.key,version:this.machine.version,type:this.type,initial:this.initial?{target:this.initial.target,source:this,actions:this.initial.actions.map(G),eventType:null,reenter:!1,toJSON:()=>({target:this.initial.target.map(e=>`#${e.id}`),source:`#${this.id}`,actions:this.initial.actions.map(G),eventType:null})}:void 0,history:this.history,states:ot(this.states,e=>e.definition),on:this.on,transitions:[...this.transitions.values()].flat().map(e=>({...e,actions:e.actions.map(G)})),entry:this.entry.map(G),exit:this.exit.map(G),meta:this.meta,order:this.order||-1,output:this.output,invoke:this.invoke,description:this.description,tags:this.tags}}toJSON(){return this.definition}get invoke(){return q(this,"invoke",()=>E(this.config.invoke).map((e,t)=>{var c;const{src:i,systemId:n}=e,r=(c=e.id)!=null?c:ct(this.id,t),o=typeof i=="string"?i:`xstate.invoke.${ct(this.id,t)}`;return{...e,src:o,id:r,systemId:n,toJSON(){const{onDone:a,onError:h,...l}=e;return{...l,type:"xstate.invoke",src:o,id:r}}}}))}get on(){return q(this,"on",()=>[...this.transitions].flatMap(([t,i])=>i.map(n=>[t,n])).reduce((t,[i,n])=>(t[i]=t[i]||[],t[i].push(n),t),{}))}get after(){return q(this,"delayedTransitions",()=>oi(this))}get initial(){return q(this,"initial",()=>ai(this,this.config.initial))}next(e,t){const i=t.type,n=[];let r;const o=q(this,`candidates-${i}`,()=>ri(this,i));for(const c of o){const{guard:a}=c,h=e.context;let l=!1;try{l=!a||Ue(a,h,t,e)}catch(d){const g=typeof a=="string"?a:typeof a=="object"?a.type:void 0;throw new Error(`Unable to evaluate guard ${g?`'${g}' `:""}in transition for event '${i}' in state node '${this.id}':
${d.message}`)}if(l){n.push(...c.actions),r=c;break}}return r?[r]:void 0}get events(){return q(this,"events",()=>{const{states:e}=this,t=new Set(this.ownEvents);if(e)for(const i of Object.keys(e)){const n=e[i];if(n.states)for(const r of n.events)t.add(`${r}`)}return Array.from(t)})}get ownEvents(){const e=new Set([...this.transitions.keys()].filter(t=>this.transitions.get(t).some(i=>!(!i.target&&!i.actions.length&&!i.reenter))));return Array.from(e)}}const Di="#";class Ye{constructor(e,t){var i,n,r,o;this.config=e,this.version=void 0,this.schemas=void 0,this.implementations=void 0,this.__xstatenode=!0,this.idMap=new Map,this.root=void 0,this.id=void 0,this.states=void 0,this.events=void 0,this.id=e.id||"(machine)",this.implementations={actors:(i=t==null?void 0:t.actors)!=null?i:{},actions:(n=t==null?void 0:t.actions)!=null?n:{},delays:(r=t==null?void 0:t.delays)!=null?r:{},guards:(o=t==null?void 0:t.guards)!=null?o:{}},this.version=this.config.version,this.schemas=this.config.schemas,this.transition=this.transition.bind(this),this.getInitialSnapshot=this.getInitialSnapshot.bind(this),this.getPersistedSnapshot=this.getPersistedSnapshot.bind(this),this.restoreSnapshot=this.restoreSnapshot.bind(this),this.start=this.start.bind(this),this.root=new We(e,{_key:this.id,_machine:this}),this.root._initialize(),this.states=this.root.states,this.events=this.root.events}provide(e){const{actions:t,guards:i,actors:n,delays:r}=this.implementations;return new Ye(this.config,{actions:{...t,...e.actions},guards:{...i,...e.guards},actors:{...n,...e.actors},delays:{...r,...e.delays}})}resolveState(e){const t=Si(this.root,e.value),i=de(ue(this.root,t));return ce({_nodes:[...i],context:e.context||{},children:{},status:He(i,this.root)?"done":e.status||"active",output:e.output,error:e.error,historyValue:e.historyValue},this)}transition(e,t,i){return $e(e,t,i,[]).snapshot}microstep(e,t,i){return $e(e,t,i,[]).microstates}getTransitionData(e,t){return je(this.root,e.value,e,t)||[]}getPreInitialState(e,t,i){const{context:n}=this.config,r=ce({context:typeof n!="function"&&n?n:{},_nodes:[this.root],children:{},status:"active"},this);return typeof n=="function"?W(r,t,e,[Ce(({spawn:c,event:a,self:h})=>n({spawn:c,input:a.input,self:h}))],i,void 0):r}getInitialSnapshot(e,t){const i=Ct(t),n=[],r=this.getPreInitialState(e,i,n),o=Te([{target:[...Bt(this.root)],source:this.root,reenter:!0,actions:[],eventType:null,toJSON:null}],r,e,i,!0,n),{snapshot:c}=$e(o,i,e,n);return c}start(e){Object.values(e.children).forEach(t=>{t.getSnapshot().status==="active"&&t.start()})}getStateNodeById(e){const t=qe(e),i=t.slice(1),n=pe(t[0])?t[0].slice(Di.length):t[0],r=this.idMap.get(n);if(!r)throw new Error(`Child state node '#${n}' does not exist on machine '${this.id}'`);return le(r,i)}get definition(){return this.root.definition}toJSON(){return this.definition}getPersistedSnapshot(e,t){return Ci(e,t)}restoreSnapshot(e,t){const i={},n=e.children;Object.keys(n).forEach(a=>{const h=n[a],l=h.snapshot,d=h.src,g=typeof d=="string"?De(this,d):d;if(!g)return;const u=se(g,{id:a,parent:t.self,syncSnapshot:h.syncSnapshot,snapshot:l,src:d,systemId:h.systemId});i[a]=u});const r=ce({...e,children:i,_nodes:Array.from(de(ue(this.root,e.value)))},this),o=new Set;function c(a,h){if(!o.has(a)){o.add(a);for(const l in a){const d=a[l];if(d&&typeof d=="object"){if("xstate$$type"in d&&d.xstate$$type===Le){a[l]=h[d.id];continue}c(d,h)}}}}return c(r.context,i),r}}function Li(s,e){return new Ye(s,e)}class Ui{constructor(e,{machine:t,options:i,callback:n}){w(this,"onNext",e=>{var t;this.currentSnapshot!==e&&(this.currentSnapshot=e,(t=this.callback)==null||t.call(this,e),this.host.requestUpdate())});this.machine=t,this.options=i,this.callback=n,this.currentSnapshot=this.snapshot,(this.host=e).addController(this)}get actor(){return this.actorRef}get snapshot(){var e,t;return(t=(e=this.actorRef)==null?void 0:e.getSnapshot)==null?void 0:t.call(e)}send(e){var t;(t=this.actorRef)==null||t.send(e)}unsubscribe(){var e;(e=this.subs)==null||e.unsubscribe()}startService(){var e;this.actorRef=se(this.machine,this.options),this.actorRef&&(this.subs=this.actorRef.subscribe(this.onNext)),(e=this.actorRef)==null||e.start()}stopService(){var e;(e=this.actorRef)==null||e.stop()}hostConnected(){this.startService()}hostDisconnected(){this.stopService()}}const ft={enabled:"enabled",disabled:"disabled"},Bi={counter:({context:s})=>s.counter+1,event:({event:s})=>s},Hi={counter:({context:s})=>s.counter-1,event:({event:s})=>s},ji=({context:s})=>s.counter<10,Ni=({context:s})=>s.counter>0,Wi=Li({id:"counter",context:{counter:0,event:void 0},initial:"enabled",states:{enabled:{on:{INC:{actions:{type:"increment"},guard:{type:"isNotMax"}},DEC:{actions:{type:"decrement"},guard:{type:"isNotMin"}},TOGGLE:{target:ft.disabled}}},disabled:{on:{TOGGLE:{target:ft.enabled}}}}},{actions:{increment:Ce(Bi),decrement:Ce(Hi)},guards:{isNotMax:ji,isNotMin:Ni}}),Yi=ie`:host {
...
::slotted(*) {
  white-space: nowrap;
}`;var O,X;class Re extends S{constructor(){super();Ve(this,O);w(this,"_callbackCounterController",t=>{this._xstate=t});w(this,"_inspectEvents",t=>{t.type==="@xstate.snapshot"&&t.event.type==="xstate.stop"&&(this._xstate={})});this._xstate={},this.counterController=new Ui(this,{machine:Wi,options:{inspect:this._inspectEvents},callback:this._callbackCounterController})}updated(t){if(super.updated&&super.updated(t),t.has("_xstate")){const{context:i,value:n}=this._xstate,r=new CustomEvent("counterchange",{bubbles:!0,detail:{...i,value:n}});this.dispatchEvent(r)}}render(){return b`
      <slot></slot>
