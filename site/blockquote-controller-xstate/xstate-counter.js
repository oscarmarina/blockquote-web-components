var p=Object.defineProperty;var u=s=>{throw TypeError(s)};var b=(s,t,e)=>t in s?p(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var o=(s,t,e)=>b(s,typeof t!="symbol"?t+"":t,e),x=(s,t,e)=>t.has(s)||u("Cannot "+e);var r=(s,t,e)=>(x(s,t,"read from private field"),e?e.call(s):t.get(s)),l=(s,t,e)=>t.has(s)?u("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(s):t.set(s,e);import{a as m,s as v,x as C}from"./assets/xstate-counter-styles.css-CHnYHoVw.js";import{c as f,a as _}from"./assets/counterMachine-BuSs9Aqo.js";class k{constructor(t,{machine:e,options:c,callback:a}){o(this,"onNext",t=>{var e;this.currentSnapshot!==t&&(this.currentSnapshot=t,(e=this.callback)==null||e.call(this,t),this.host.requestUpdate())});this.machine=e,this.options=c,this.callback=a,this.currentSnapshot=this.snapshot,(this.host=t).addController(this)}get actor(){return this.actorRef}get snapshot(){var t,e;return(e=(t=this.actorRef)==null?void 0:t.getSnapshot)==null?void 0:e.call(t)}send(t){var e;(e=this.actorRef)==null||e.send(t)}unsubscribe(){var t;(t=this.subs)==null||t.unsubscribe()}startService(){var t,e;this.actorRef=f(this.machine,this.options),this.subs=(t=this.actorRef)==null?void 0:t.subscribe(this.onNext),(e=this.actorRef)==null||e.start()}stopService(){var t;(t=this.actorRef)==null||t.stop()}hostConnected(){this.startService()}hostDisconnected(){this.stopService()}}var n,i;class h extends m{constructor(){super();l(this,n);o(this,"_callbackCounterController",e=>{this._xstate=e});o(this,"_inspectEvents",e=>{e.type==="@xstate.snapshot"&&e.event.type==="xstate.stop"&&(this._xstate={})});this._xstate={},this.counterController=new k(this,{machine:_,options:{inspect:this._inspectEvents},callback:this._callbackCounterController})}updated(e){if(super.updated&&super.updated(e),e.has("_xstate")){const{context:c,value:a}=this._xstate,d=new CustomEvent("counterchange",{bubbles:!0,detail:{...c,value:a}});this.dispatchEvent(d)}}render(){return C`
      <slot></slot>
